...
<?PHP
	...
	$sql 	= "SELECT *,tbl_formcuti.NIK1 AS NIK1,tbl_formcuti.NIK2 AS NIK2,tbl_formcuti.TglMasuk AS TglMasuk, tbl_formcuti.Alamat AS Alamat,tbl_profile.AlamatDomisili AS AlamatRumah,tbl_formcuti.CreatedTime AS CreatedTime
           FROM tbl_formcuti LEFT JOIN
					  ...
					  WHERE tbl_formcuti.CutiId='$_GET[id]' AND FormCutiNIK='$_GET[nik]'";
  ...
  $gann      = mysql_fetch_array(mysql_query("SELECT * FROM tbl_profile WHERE NIK='$data[NIKPengganti]'"));
  ...
  <tr>
    <td scope="row"><table width="900" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="6" class="thickBorder">: <?php echo $data['AlamatRumah']; ?></td>
        <td colspan="2" class="thickBorder">HP: <?php echo $data['Hp']; ?></td>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="6" class="thickBorder">: <?php echo $gann['Nama']; ?></td>
  ...
  <tr>
    <td scope="row"><table width="900" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="2" class=""><div align="center"><strong><?php echo $Apv1 ?></strong></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2" class=""><div align="center"><strong><?php echo $Apv2 ?></strong></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="2" class="thickBorder"><div align="center"><?php echo $NameApv1 ?></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2" class="thickBorder"><div align="center"><?php echo $NameApv2 ?></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
