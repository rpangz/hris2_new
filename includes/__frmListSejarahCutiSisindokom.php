...
include "koneksi/koneksi.php";
	...
	$tampil = mysql_query("SELECT * FROM tbl_profile WHERE NIK='$nik' AND CompanyId='2'");
...
while ($row1 = mysql_fetch_array($SQL1)){
    ...
    <thead>
        <tr>
            ...
            <th><input type="checkbox" name="ct[]" value='.$row1['HakId'].'> Email #'.$no.'</th>
...
if ($JH >0){
    ...
    //echo'<br/><input type="submit" value=" Send Email  to '.$Alamat.'" '.$sta.'></form>';
