...
<body onload="loadprompt()">
     ...
     <div id="loadingdiv" class="content">
        <label style="font-size: 18px; visibility: hidden;" id="loadingajaxlabel">PLEASE WAIT <br> SENDING EMAIL. . .</label><br>
    ...
    <script>
        ...
        function loadprompt(){
           bootbox.prompt({
                title: "Alasan Pemberhentian Reminder Sertifikasi : ",
                inputType: 'textarea',
...
function prosesdata($certid,$alasan,$userid) {
        ...
        //$query  = mysql_query("UPDATE tbl_profile_certification SET CertStatus=0 WHERE CertId='".$certid."'");
        $mysqlcomm = "INSERT INTO tbl_profile_certification_stop(certid, certnik, alasan, createuser, createtime) 
                               VALUE 
                               ('".$certid."','".getcertnik($certid)."','".$alasan."','".$userid."',now())";       
        ...
        echo "Stop Reminder Berhasil Dan Email Telah Dikirim,Klik OK Untuk Kembali Ke List Data";        
        //return "berhasil";
...
function sendmailtoatasan($certid){
    ...
    */
    $mysqlcomm = "  SELECT d.nama,d.nik,d.email FROM tbl_profile_certification a
                    ...
                    INNER JOIN tbl_profile d ON c.superiors_nik=d.nik
                    WHERE a.certid = '".$certid."'
                    GROUP BY c.superiors_id   ";
