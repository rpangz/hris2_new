...
//require 'terbilang.php';
	...
	//mysql_query("UPDATE tbl_formijin SET StatusForm ='X' WHERE IjinId = '$_GET[id]'");
...
$data   = mysql_fetch_array(mysql_query("SELECT * FROM tbl_formijin WHERE IjinId=$_GET[id]"));
	...
	$ID     = $data['IjinId'];
	$MyNIK  = $data['NIK'];
	$Alasan = $data['AlasanVoid'];
	$AlasanKu = $data['Alasan'];
...
<tr>
    ...
    <td width='10'><span class=style1>:</span></td>
    <td><span class=style1>$MyNIK</span></td>
</tr>
...
<tr>
    ...
    <td><span class=style1>:</span></td>
    <td><span class=style1>$AlasanKu</span></td>
</tr>
...
$mail->Body     = $body;
$StatusApproval = 'Permohonan Ijin Di VOID dengan alasan '.$Alasan;
