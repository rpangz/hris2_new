...
while ($row1 = mysql_fetch_array($SQL1)){
  ...
  echo'<table class="zui-table zui-table-horizontal zui-table-highlight">
        ...
        <tr>        
            ...
            <th width="20%"><div align="right">'.$row1['Qty'].'</div></th>           
        </tr>
    </thead>
    <tbody>';
    ...
    while ($ww = mysql_fetch_array($deta1)){
        ...
        if ($TglBuat < $TglMasuk){
           ...
           echo '            
                <tr>
                    <td><font color="'.$sopi.'">'.$ww['Keperluan'].'</font><br/><ul>';
                ...
                echo'</ul></td>
                    <td><div align="right">- '.$JmlHari.'</div></td>       
            </tr>';
...
while ($row2 = mysql_fetch_array($SQL2)){
    ...
    <thead>
       <tr>
        ...
        <tr>        
            <th align="center">Hak cuti tahun kerja '.$PeriodeKerja1.' - ' .$PeriodeKerja2.' ( '.$years.' Thn )</th>
            <th width="20%"><div align="right">'.$row1['Qty'].'</div></th>           
        </tr>
    ...
    while ($wa = mysql_fetch_array($deta1)){
        ...
        if ($TglBuat < $TglMasuk){
           ...
           echo '            
                <tr>
                    <td><font color="'.$sopu.'">'.$wa['Keperluan'].'</font><br/><ul>';
...
if ($JH >0){
    ...
    while ($wa = mysql_fetch_array($deta2)){
        ...
        if ($TglBuat < $TglMasuk){
           ...
           echo '            
                <tr>
                    <td><font color="'.$sopu.'">'.$item_cuti['JenisItemCutiName'].'</font> ('.$wa['Keperluan'].')<br/><ul>';
                ...
                echo'</ul></td>
                <td width="20%"><div align="right">- '.$JmlHari.'</div></td>       
            </tr>';
            $i++;
