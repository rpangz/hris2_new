...
<div id="md_table_education_container">
    ...
    <table id="md_table_education" class="table table-striped table-bordered" style="display:none">
        <thead>
            <tr>
                ...
                <th>GPA</th>
                <th>Major</th>
                <th colspan="2" width="3%">File Attachment</th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
    ...
    <div class="fbutton">
        <span id="md_field_education_add" class="add btn btn-default">
            <i class="glyphicon glyphicon-education"></i> Educations </span>
    </div>
    <br />
...
<script type="text/javascript">
    ...
    function add_table_row_education(value){
        ...
        */
        ...
        component += '<td>';
        component += '<input style="width: 250px;" id="md_field_education_col_EduInstitution_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="tftextinput" column_name="EduInstitution" autocomplete="off" name="EduInstitution" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        */
        ...
        component += '<td>';
        component += '<select style="width: 150px !important; min-width: 150px; max-width: 150px;" id="md_field_education_col_EduLevelId_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col numeric chzn-select" column_name="EduLevelId" >';
