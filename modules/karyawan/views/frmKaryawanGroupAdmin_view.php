    ...
    <tbody>
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    ...
                    while ($ws5 = mysql_fetch_array($Cert)){
                        ...
                        if(empty($ws5['CertFileUrl']) || $ws5['CertFileUrl'] == "0000-00-00"){
                            if($ws5['CertItem']=="5"){
                               $CertValidFinish = "NO EXP"; 
                            } else {
                               $CertValidFinish = " - ";
                            }
                        } else {
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $project = mysql_query("SELECT *,DATE_FORMAT(ProjectDate,'%M %Y') projectdatebln FROM tbl_profile_projecthistory WHERE ProjectNIK=".$nikki." ORDER BY ProjectId ASC");
