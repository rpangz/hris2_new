...
<table id="md_table_photos" class="table table-striped table-bordered">
    <thead>
        <tr>
            <th style="width:400px; text-align:center">File - jpg | jpeg  [Maksimal 1 MB] </th>
...
<!--<input id="md_field_photos_add" class="btn btn-default" type="button" value="Add Attachment Files" />-->

<div class="fbutton">
        <span id="md_field_photos_add" class="add btn btn-default">
...
<script type="text/javascript">
    ...
    function add_table_row_photos(value){
        ...
        //http://astapp02/e-support/assets/uploads/files/9d3ac-book1.xlsx

        }else{
            component += '<input accept="image/jpg, image/jpeg" id="md_field_photos_col_url_'+RECORD_INDEX_photos+
        ...
        // Delete Button
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        //component += '<td><input class="md_field_photos_download btn btn-default" record_index="'+RECORD_INDEX_photos+'" primary_key="" type="button" value="Download" /></td>';
    ...
    $(document).ready(function(){
        ...
        // md_field_photos_delete.click (Delete row)
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        $('.md_field_photos_download').live('click', function(){
            var record_index = $(this).attr('record_index');
            // remove the component
            $('#md_field_photos_tr_'+record_index).remove();
