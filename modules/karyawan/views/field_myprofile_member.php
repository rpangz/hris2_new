...
<script type="text/javascript">
    ...
    function add_table_row_citizen(value){
        ...
        component += '<td>';
        component += '<input style="width: 350px;" id="md_field_citizen_col_MemberName_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberName" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width: 100px;" id="md_field_citizen_col_MemberLahir_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col datetime-input" column_name="MemberLahir" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<select style="width: 100px;" id="md_field_citizen_col_MemberStatus_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberStatus" >';
        ...
        component += '<td>';
        component += '<select style="width: 100px;" id="md_field_citizen_col_MemberSex_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberSex" >';
