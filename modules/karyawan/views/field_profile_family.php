...
<div id="md_table_family_container">
    ...
    <table id="md_table_family" class="table table-striped table-bordered" style="display:none">
        <thead>
            <tr>
                <th>Name</th>
                <th>Birth Date</th>
...
<script type="text/javascript">
    ...
    function add_table_row_family(value){
        ...
        component += '<td>';
        component += '<input style="width: 300px;" id="md_field_family_col_MemberName_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col" column_name="MemberName" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width: 80px;" id="md_field_family_col_MemberLahir_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col datetime-input" column_name="MemberLahir" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<select style="width: 200px !important; min-width: 200px; max-width: 200px;" id="md_field_family_col_MemberTempatLahir_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberTempatLahir" >';
        ...
        component += '<td>';
        component += '<select style="width: 90px !important; min-width: 90px; max-width: 90px;" id="md_field_family_col_MemberStatus_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberStatus" >';
        ...
        component += '<td>';
        component += '<select style="width: 100px !important; min-width: 100px; max-width: 100px;" id="md_field_family_col_MemberSex_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberSex" >';
        ...
        component += '<td>';
        component += '<select style="width: 100px !important; min-width: 100px; max-width: 100px;" id="md_field_family_col_MemberBloodType_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberBloodType" >';
        ...
        component += '<td>';
        component += '<input style="width: 200px;" id="md_field_family_col_MemberKTP_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col" column_name="MemberKTP" type="text" value="'+field_value+'"/>';
        component += '</td>';
