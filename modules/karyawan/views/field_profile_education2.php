...
<div id="md_table_education_container">
    <div id="no-datamd_table_education">No data 2</div>
...
<script type="text/javascript">
    ...
    function add_table_row_education(value){
        ...
        if(typeof(value) != 'undefined' && value.hasOwnProperty('EduStart')){
          field_value = php_date_to_js(value.EduStart);

        }
        component += '<td>';
        component += '<input style="width: 80px;" id="md_field_education_col_EduStart_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col datetime-input" column_name="EduStart" type="text" value="'+field_value+'"/>';
        component += '</td>';
        */
        ...
        if(typeof(value) != 'undefined' && value.hasOwnProperty('EduFinish')){
          field_value = php_date_to_js(value.EduFinish);

        }
        component += '<td>';
        component += '<input style="width: 80px;" id="md_field_education_col_EduFinish_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col datetime-input" column_name="EduFinish" type="text" value="'+field_value+'"/>';
        component += '</td>';
        */
        ...
        component += '<td>';
        component += '<input style="width: 250px;" id="md_field_education_col_EduInstitution_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col" column_name="EduInstitution" type="text" value="'+field_value+'"/>';
        component += '</td>';
        */
        ...
        component += '<td>';
        component += '<input style="width: 100px;" id="md_field_education_col_EduCity_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col" column_name="EduCity" type="text" value="'+field_value+'"/>';
        component += '</td>';
        */
        ...
        component += '<td>';
        component += '<input style="width: 150px;" id="md_field_education_col_EduFaculty_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col" column_name="EduFaculty" type="text" value="'+field_value+'"/>';
        component += '</td>';*/
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        //    FIELD "EduCertificate"
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('EduCertificate')){
          field_value = value.EduCertificate;
        }
        component += '<td>';
        component += '<select style="width: 150px !important; min-width: 150px; max-width: 150px;" id="md_field_education_col_EduCertificate_'+RECORD_INDEX_education+'" record_index="'+RECORD_INDEX_education+'" class="md_field_education_col numeric chzn-select" column_name="EduCertificate" >';
        var options = OPTIONS_education.EduCertificate;
        component += '<option value></option>';
        for(var i=0; i<options.length; i++){
          var option = options[i];
          var selected = '';
