...
<script type="text/javascript">
    ...
    function add_table_row_certification(value){
        ...
        component += '<td>';
        component += '<input style="width: 100px;" id="md_field_certification_col_CertValidFinish_'+RECORD_INDEX_certification+'" record_index="'+RECORD_INDEX_certification+'" class="md_field_certification_col datetime-input" column_name="CertValidFinish" type="text" value="'+field_value+'" onclick="cekdata(this.id,this.value)" />';
        component += '</td>';
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        //    FIELD "CertStatus"
        /////////////////////////////////////////////////////////////////////////////////////////////////////
