...
echo"
    ...
    <a href='https://$_SERVER[SERVER_NAME]/hris2/karyawan/frmMyCV/index/edit/".$_SESSION['NIK']."/?state=last_update&id=$process_cv_number'><i>see the last update form</i></a>
...
<div id="cv" class="instaFade">
        ...
        <div class="social">
            <ul>
              <li><a class="north" href="https://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/karyawan/frmMyCV/index/edit/<?php echo $_SESSION['NIK'] ?>" title="Edit"><img src="https://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/images/icn-edit.png" alt="Edit" width="25" class="img-responsive"/></a></li> 
