...
$company_id = $this->config->item('cms_provis_id');
...
echo"
    <div class='alert alert-warning'>
      ...
      <strong>Warning!</strong> Form CV <b>$Nama</b> Sedang Proses Approval, Data Dibawah Belum Diperbaharui.
    <a href='https://$_SERVER[SERVER_NAME]/hris2/karyawan/frmKaryawanProvis/index/edit/".$NIK."/?state=last_update&id=$process_id'><i>see the last update form</i></a>
...
<div id="cv" class="instaFade">
        ...
        <?php 
        echo'<li><a class="north" href="https://'.$_SERVER['SERVER_NAME'].'/hris2/'.$this->uri->segment('1').'/'.$this->uri->segment('2').'/index/edit/'.$nikki.'" title="Edit"><img src="https://'.$_SERVER['SERVER_NAME'].'/hris2/images/icn-edit.png" alt=" "></a></li>
              <li><a class="north" href="'.$link2print.'" target="_blank" title="Download .doc"><img src="https://'.$_SERVER['SERVER_NAME'].'/hris2/images/icn-word1.png" alt="Download .doc" width="25"/></a></li>
            <li><a class="north" id="contact" href="https://'.$_SERVER['SERVER_NAME'].'/hris2/includes/mailer/frmKaryawanALL/?nik='.$nikki.'" target="_blank" title="Send Email to '.$data['Email'].'"><img src="https://'.$_SERVER['SERVER_NAME'].'/hris2/images/icn-contact.jpg" alt="" /></a></li>';
        ?>
            </ul>
        </div>
    ...
    <tbody>
        ...
        <?php 
        $workexp = mysql_query("SELECT * FROM tbl_profile_workexperience WHERE WorkExpNIK=".$nikki." AND WorkExpProcessId=".$process_id." ORDER BY WorkExpId ASC");
        ...
        while ($ws1 = mysql_fetch_array($workexp)){
                ...
                if (is_null($ws1['WorkExpFileUrl']) || empty($ws1['WorkExpFileUrl'])){
                    ...
                    ?>
        <tr>
            <td class="organisationnumber" width="90px"><?php echo format_tanggal_id($date=$ws1['WorkExpStart']) ?></td>
            <td class="organisationname" width="90px"><?php echo format_tanggal_id($date=$ws1['WorkExpFinish']) ?></td>
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $education = mysql_query("SELECT * FROM tbl_profile_education WHERE EduNIK=".$nikki." AND EduProcessId=".$process_id." ORDER BY EduId ASC");
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $training = mysql_query("SELECT * FROM tbl_profile_training WHERE TrainingNIK=".$nikki." AND TrainingProcessId=".$process_id." ORDER BY TrainingId ASC");
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $skill = mysql_query("SELECT * FROM tbl_profile_technicalskill WHERE TechnicalSkillNIK=".$nikki." AND TechnicalSkillProcessId=".$process_id." ORDER BY TechnicalSkillId ASC");
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $Cert = mysql_query("SELECT * FROM tbl_profile_certification WHERE CertNIK=".$nikki." AND CertProcessId=".$process_id." ORDER BY CertId ASC");
                ...
                ?>
                    <tr>
                        <td class="organisationnumber" width="90px"><?php echo format_tanggal_id($date=$ws5['CertDate']) ?></td>
                        ...
                        <td class="organisationname"><?php echo format_tanggal_id($date=$ws5['CertValidStart']).' s/d '.format_tanggal_id($date=$ws5['CertValidFinish']); ?></td>
                        <td class="organisationname"><div align="center"><?php echo $download ?></div></td>                        
                    </tr>
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $project = mysql_query("SELECT * FROM tbl_profile_projecthistory WHERE ProjectNIK=".$nikki." AND ProjectProcessId=".$process_id." ORDER BY ProjectId ASC");
                ...
                ?>
                    <tr>
                        <td class="organisationnumber" width="90px"><?php echo format_tanggal_id($date=$ws6['ProjectDate']) ?></td>
        ...
        <div class="sectionTitle">
            ...
            <table class="layout display responsive-table">
                ...
                <?php 
                    $fileku = mysql_query("SELECT * FROM tbl_profile_files WHERE file_nik=".$nikki." AND file_process_id=".$process_id." ORDER BY file_id ASC");
