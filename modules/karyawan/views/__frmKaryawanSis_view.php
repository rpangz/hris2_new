...
<div id="cv" class="instaFade">
        ...
        <div class="social">
            <ul>
              <li><a class='north' href="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/karyawan/frmKaryawanSis/index/edit/<?php echo $nikki ?>" title="Edit"><img src="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/images/icn-edit.png" alt="" /></a></li> 
