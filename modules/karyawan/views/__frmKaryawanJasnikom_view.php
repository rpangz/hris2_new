<style type="text/css">
  a[href="<?php echo site_url('{{ module_path }}/frmKaryawanJasnikom/index/delete/4833');?>"]
  {
    visibility : hidden;
    pointer-events: none;
        cursor: default;
...
<div id="cv" class="instaFade">
        ...
        <div class="social">
            <ul>
              <li><a class='north' href="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/karyawan/frmKaryawanJasnikom/index/edit/<?php echo $nikki ?>" title="Edit"><img src="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/images/icn-edit.png" alt="" /></a></li> 
              <li><a class='north' href="#" title="Download .xls"><img src="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/images/icn-save.jpg" alt="Download the pdf version" /></a></li>
              <!--<li><a class='north' href="javascript:window.print()" title="Print"><img src="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/images/icn-print.jpg" alt="" /></a></li>-->
              <li><a class='north' id="contact" href="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/includes/mailer/frmKaryawanALL/?nik=<?php echo $nikki ?>" target="_blank" title="Send Email to [<?php echo $data['Email'] ?>]"><img src="http://<?php echo $_SERVER['SERVER_NAME'] ?>/hris2/images/icn-contact.jpg" alt="" /></a></li>
