...
<div class="wrapper">
    ...
    <div class="pull-left">
        <div class="btn-group">
            <a href="<?php echo site_url('karyawan/form_my_resume/edit/'.$primary_key)?>" class="btn btn-primary btn-flat" role="button"><i class="fa fa-pencil"></i></a>
            <a href="<?php echo site_url('includes/printer/prt_frmMyCV.php?nik='.$primary_key)?>" class="btn btn-primary btn-flat" role="button"><i class="fa fa-file-word-o"></i></a>
