 ...
 */
class frmKaryawanJasnikom extends CMS_Priv_Strict_Controller {
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmKaryawanJasnikom_view', $output,
        $this->cms_complete_navigation_name('frmKaryawanJasnikom'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/karyawan/frmKaryawanJasnikom/get_states/', site_url().'/karyawan/frmKaryawanJasnikom/get_cities/', site_url().'/karyawan/frmKaryawanJasnikom/get_units/',site_url().'/karyawan/frmKaryawanJasnikom/get_seksi/'),
