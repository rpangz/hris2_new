...
/**
 * Installation script for karyawan
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.karyawan';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Karyawan',
            $module_path.'/karyawan', $this->PRIV_EVERYONE);
