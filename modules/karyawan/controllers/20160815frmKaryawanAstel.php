...
class frmKaryawanAstel extends CMS_Priv_Strict_Controller {
    ...
    public function _after_update($post_array, $primary_key){
        ...
        //echo "<script language='javascript'>alert('Your data has been successfully stored into the database');window.location.href='http://astelapps.unias.com/hris2/karyawan/frmKaryawanAstel';</script>";
