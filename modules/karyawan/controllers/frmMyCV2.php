...
class frmMyCV2 extends CMS_Priv_Strict_Controller {
...
*/
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmMyCV2_view', $output,
        $this->cms_complete_navigation_name('frmMyCV2'));    
    }
...
// education
    ...
    public function _callback_field_workexp($value, $primary_key){
        ...
        return $this->load->view($this->cms_module_path().'/field_profile_workexp2',$data, TRUE);
    }
    ...
    public function _callback_field_Education($value, $primary_key){
        ...
        return $this->load->view($this->cms_module_path().'/field_profile_education2',$data, TRUE);
    }
    ...
    public function certification_expired_date($id,$date){
        $today          = date('Y-m-d');
        $the_7th_day    = date('Y-m-d',strtotime('+7 day',$date));

        if ($today > $the_7th_day){
            mysql_query("UPDATE tbl_profile_certification SET CertStatus='0' WHERE CertId ='$id'");
        }
        else{
            mysql_query("UPDATE tbl_profile_certification SET CertStatus='1' WHERE CertId ='$id'");
        }
