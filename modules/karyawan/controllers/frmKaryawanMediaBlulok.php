 ...
 * @author Dompak
 */
class frmKaryawanMediaBlulok extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        $company_id         = $this->cms_get_config('cms_mediablulok_id');
        ...
        $crud->columns('Photos','NIK','Nama','NoKK','NoKTP','TglKTP','Sex','Agama','TglLahir','TptLahir','AlamatKTP','AlamatDomisili','Kodepos','Telp','Hp','BloodType','StatusDiri','NamaIbuKandung','NoNPWP','NoKPJ','NoBPJSKes','EmailPribadi','CompanyId','DivisiID','DeptID','UnitID','SeksiID','Email','member','bStatus','TermsAndConditions','UpdatedTime');
    ...
    public function _example_output($output = null){
        $this->view($this->cms_module_path().'/frmKaryawanMediaBlulok_view', $output,
        $this->cms_complete_navigation_name('frmKaryawanMediaBlulok'));    
    }
    ...
    public function _after_insert_or_update($post_array, $primary_key){
        ...
        foreach($insert_records as $insert_record){
            ...
            $MAXIMUM_FILESIZE = 1000 * 1000; // mean 1 MB
