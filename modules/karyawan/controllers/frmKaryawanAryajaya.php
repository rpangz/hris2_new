 ...
 * @author Dompak
 */
class frmKaryawanAryajaya extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        $company_id         = $this->cms_get_config('cms_aryajaya_id');
    ...
    public function _example_output($output = null){
        $this->view($this->cms_module_path().'/frmKaryawanAryajaya_view', $output,
        $this->cms_complete_navigation_name('frmKaryawanAryajaya'));    
    }
