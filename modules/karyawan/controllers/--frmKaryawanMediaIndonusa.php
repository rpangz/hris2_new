 ...
 * @author Dompak
 */
class frmKaryawanMediaIndonusa extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        $crud->columns('Photos','NIK','Nama','NoKK','NoKTP','TglKTP','Sex','Agama','TglLahir','TptLahir','AlamatKTP','AlamatDomisili','Kodepos','Telp','Hp','BloodType','StatusDiri','NamaIbuKandung','NoNPWP','NoKPJ','NoBPJSKes','EmailPribadi','CompanyId','DivisiID','DeptID','UnitID','SeksiID','Email','member','bStatus','UpdatedTime');
        ...
        $crud->required_fields('NIK','Nama','CompanyId','DivisiID','DeptID','UnitID');
        ...
        $crud->display_as('Files','Attachment Scan KTP');
    ...
    public function _example_output($output = null){
        $this->view($this->cms_module_path().'/frmKaryawanMediaIndonusa_view', $output,
        $this->cms_complete_navigation_name('frmKaryawanMediaIndonusa'));    
    }
