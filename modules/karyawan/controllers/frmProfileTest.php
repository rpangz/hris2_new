 ...
 * @author Dompak
 */
class frmProfileTest extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
       ...
       // $crud->set_theme('flexigrid');
        ...
        $this->config->set_item('grocery_crud_file_upload_allow_file_types_profile','gif|jpeg|jpg|png');
        ...
        */
        ...
        $crud->edit_fields('NIK','NoKK','NoKTP','TglKTP','Nama','Sex','Agama','TglLahir','TptLahir','AlamatKTP','CityKTP','KodeposKTP','AlamatDomisili','CityDomisili','Kodepos','Telp','Hp','BloodType','StatusDiri','NamaIbuKandung','NoNPWP','NoKPJ','NoBPJSKes','EmailPribadi','CompanyId','DivisiID','DeptID','UnitID','SeksiID','Email','UpdatedBy','UpdatedTime','member','Files','TermsAndConditions');
        ...
        $crud->required_fields('NoKK','Nama','NoKTP','Sex','TglLahir','TptLahir','Agama','Status','AlamatKTP','CityKTP','KodeposKTP','AlamatDomisili','CityDomisili','Kodepos','Hp','BloodType','StatusDiri','NamaIbuKandung','NoNPWP','NoKPJ','EmailPribadi','Email','TglMasuk','TermsAndConditions');
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmProfileTest_view', $output,
        $this->cms_complete_navigation_name('frmProfileTest'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/karyawan/frmProfileTest/get_states/', site_url().'/karyawan/frmProfileTest/get_cities/', site_url().'/karyawan/frmProfileTest/get_units/',site_url().'/karyawan/frmProfileTest/get_seksi/'),
            ...
            return '<div class="row">
                      <div class="col-lg-6">
                        <div class="input-group">          
                          ...
                          <span class="input-group-addon">Seumur Hidup</span>
                        </div>
                      </div>
                      </div>'.$js;
