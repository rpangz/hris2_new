 ...
 */
class frmKaryawanSis extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->columns('Photos','NIK','Nama','Sex','TglMasuk','Status','StatusDiri','CompanyId','DivisiID','DeptID','JabatanID','bStatus','kerja','member');
        ...
        */
		...
		$crud->add_fields('Photos','NIK','NoKTP','TglKTP','Nama','Sex','Agama','TglLahir','TptLahir','Kodepos','Telp',
                            'Hp','Email','AlamatKTP','StatusDiri','TglMenikah','TglMasuk','TglKeluar','BandSkrg','Status',
		...
		$crud->required_fields('NIK','Nama','Sex','TglLahir','TptLahir','Agama','BandSkrg','TglMasuk','Status','StatusDiri',
            'CompanyId','DivisiID','DeptID','JabatanID','AlamatKTP','Email');
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmKaryawanSis_view', $output,
        $this->cms_complete_navigation_name('frmKaryawanSis'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/karyawan/frmKaryawanSis/get_states/', site_url().'/karyawan/frmKaryawanSis/get_cities/', site_url().'/karyawan/frmKaryawanSis/get_units/',site_url().'/karyawan/frmKaryawanSis/get_seksi/'),
