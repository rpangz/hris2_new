 ...
 * @author Dompak
 */
class frmKaryawanSisindokom extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        $crud->required_fields('NIK','Nama','Sex','Agama','TglLahir','TglMasuk','Email','CompanyId','DivisiID','DeptID','Status','bStatus','Grade','JabatanID');
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmKaryawanSisindokom_view', $output,
        $this->cms_complete_navigation_name('frmKaryawanSisindokom'));    
    }
    ...
    public function _after_update($post_array, $primary_key){
        ...
        //echo "<script language='javascript'>alert('Your data has been successfully stored into the database');window.location.href='https://apps.unias.com/hris2/karyawan/frmKaryawanSisindokom';</script>";
        
        $this->db->update('tbl_kpi_header_form',array('CompanyID' => $post_array['CompanyId'], 'DivisionID' => $post_array['DivisiID'], 'DepartmentID' => $post_array['DeptID'], 'UnitID' => $post_array['UnitID']), array('EmployeeID'=> $post_array['NIK']));
...
// education
    ...
    public function _callback_field_project($value, $primary_key){
        ...
        $query = $this->db->select('ProjectId,ProjectNIK,ProjectDate,ProjectName,ProjectInstitution,ProjectYear,ProjectLength,ProjectTechnicalSpec,ProjectPosition,ProjectFileName,ProjectFileUrl,ProjectStatus,ProjectApv,ProjectProcessId,ProjectUpdatedBy')
            ->from('tbl_profile_projecthistory')
