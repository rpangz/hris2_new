...
class karyawan_model extends CI_Model {
  ...
  protected $tbl_profile       = 'tbl_profile';
	...
	public function hitung_jumlah_cuti($hak_cuti, $nik_lama){
		  ...
		  $SQL    = "SELECT COUNT(a.DetailCutiId) AS total FROM tbl_formcutidetail AS a INNER JOIN tbl_formcuti AS b ON a.CutiId=b.CutiId WHERE b.HakCutiId=".$hak_cuti." AND b.FormCutiNIK=".$nik_lama;
      $query  = $this->db->query($SQL);
      $data   = $query->row(0);
    ...
    public function certification_profile($primary_key){
        ...
        $SQL    = "SELECT a.CertDate,b.CertItemName,a.CertProduct,a.CertName,a.CertPartnerName,a.CertValidStart,a.CertValidFinish FROM tbl_profile_certification AS a INNER JOIN tbl_certification_item AS b ON a.CertItem=b.CertItemId WHERE a.CertNIK=".$primary_key." AND a.CertStatus=0 ORDER BY a.CertDate ASC";
