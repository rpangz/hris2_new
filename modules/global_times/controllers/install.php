...
/**
 * Installation script for global_times
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.global_times';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Global Times',
            $module_path.'/global_times', $this->PRIV_EVERYONE);
