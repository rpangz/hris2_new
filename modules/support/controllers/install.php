...
/**
 * Installation script for support
 *
...
class Install extends CMS_Module_Installer {
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Support',
            $module_path.'/support', $this->PRIV_EVERYONE);
