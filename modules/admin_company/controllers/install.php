...
/**
 * Installation script for admin_company
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_company';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Company',
            $module_path.'/admin_company', $this->PRIV_EVERYONE);
