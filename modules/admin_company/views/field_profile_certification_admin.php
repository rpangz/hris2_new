    ...
    <table id="md_table_certification" class="table table-striped table-bordered" style="display:none">
        <thead>
            <tr>
                ...
                <th>Valid From</th>
                <th>Valid Until</th>
                <th width="4%"><div align="center">Status <a href="#" style="text-decoration: none;" class="glyphicon glyphicon-question-sign tip-right" data-toggle="tooltip" title="Notifikasi reminder hanya untuk sertifikat yang active"></a></div></th>
...
<script type="text/javascript">
    ...
    function add_table_row_certification(value){
        ...
        component += '<td>';
        component += '<select style="width: 100px !important; min-width: 100px; max-width: 100px;" id="md_field_certification_col_CertStatus_'+RECORD_INDEX_certification+'" record_index="'+RECORD_INDEX_certification+'" class="md_field_certification_col numeric chzn-select" column_name="CertStatus" >';
        var options = OPTIONS_certification.CertStatus;
        component += '<option value></option>';
        for(var i=0; i<options.length; i++){
          var option = options[i];
          var selected = '';
