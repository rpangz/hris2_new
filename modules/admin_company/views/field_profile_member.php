...
<div id="md_table_citizen_container">
    ...
    <div class="fbutton">
        <span id="md_field_citizen_add" class="add btn btn-default">
            <i class="glyphicon glyphicon-plus-sign"></i> Anggota Keluarga </span>
    </div>
    <br />
...
<script type="text/javascript">
    ...
    function add_table_row_citizen(value){
        ...
        component += '<td>';
        component += '<input style="width: 190px;" id="md_field_citizen_col_MemberName_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberName" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width: 80px;" id="md_field_citizen_col_MemberLahir_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col datetime-input" column_name="MemberLahir" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<select style="width: 90px !important; min-width: 90px; max-width: 90px;" id="md_field_citizen_col_MemberTempatLahir_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberTempatLahir" >';
        var options = OPTIONS_citizen.MemberTempatLahir;
        ...
        component += '<td>';
        component += '<select style="width: 90px !important; min-width: 90px; max-width: 90px;" id="md_field_citizen_col_MemberStatus_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberStatus" >';
        var options = OPTIONS_citizen.MemberStatus;
        component += '<option value></option>';
        for(var i=0; i<options.length; i++){
          var option = options[i];
          var selected = '';
        ...
        component += '<td>';
        component += '<select style="width: 100px !important; min-width: 100px; max-width: 100px;" id="md_field_citizen_col_MemberSex_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberSex" >';
        var options = OPTIONS_citizen.MemberSex;
        component += '<option value></option>';
        for(var i=0; i<options.length; i++){
          var option = options[i];
          var selected = '';
        ...
        component += '<td>';
        component += '<select style="width: 70px !important; min-width: 70px; max-width: 70px;" id="md_field_citizen_col_MemberBloodType_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberBloodType" >';
        var options = OPTIONS_citizen.MemberBloodType;
        component += '<option value></option>';
        for(var i=0; i<options.length; i++){
          var option = options[i];
          var selected = '';
        ...
        component += '<td>';
        component += '<input style="width: 180px;" placeholder="Nomor Induk Kependudukan ditulis tanpa spasi" id="md_field_citizen_col_MemberKTP_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberKTP" type="text" value="'+field_value+'"/>';
        component += '</td>';
    ...
    $(document).ready(function(){
        ...
        $('#md_field_citizen_add').click(function(){
            ...
            if($("tr.md_field_citizen_tr").length<'<?php echo $Max ?>')
            // new data
            var data = new Object();
