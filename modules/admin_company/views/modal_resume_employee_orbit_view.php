<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>    
    ...
    <link rel="stylesheet" href="<?php echo $base_url;?>assets/orbit/plugins/font-awesome/css/font-awesome.css">
    <link id="theme-style" rel="stylesheet" href="<?php echo $base_url;?>assets/orbit/css/styles.css">
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                <img class="profile" src="<?php echo $base_url;?>assets/uploads/files/<?php echo $profile['Photos'];?>" alt="" width="100" height="100"/>
