...
<div id="md_table_family_container">
    ...
    <table id="md_table_family" class="table table-striped table-bordered" style="display:none;width:98%;table-layout:fixed;">
        <thead>
            <tr>
                <th>Name</th>
                <th>Birth Date</th>
    ...
    <div class="fbutton">
        <span id="md_field_family_add" class="add btn btn-default btn-sm">
            <i class="glyphicon glyphicon-plus-sign"></i> Add Family </span>
    </div>
    <br />
...
<script type="text/javascript">
    ...
    function add_table_row_family(value){
        ...
        component += '<td>';
        component += '<input id="md_field_family_col_MemberName_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col form-control" column_name="MemberName" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input id="md_field_family_col_MemberLahir_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col datepicker-input form-control" column_name="MemberLahir" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<select style="width: 100% !important; min-width: 100% !important; max-width: 100% !important;" id="md_field_family_col_MemberTempatLahir_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberTempatLahir" >';
        ...
        component += '<td>';
        component += '<select style="width: 100% !important; min-width: 100% !important; max-width: 100% !important;" id="md_field_family_col_MemberStatus_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberStatus" >';
        ...
        component += '<td>';
        component += '<select style="width: 100% !important; min-width: 100% !important; max-width: 100% !important;" id="md_field_family_col_MemberSex_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberSex" >';
        ...
        component += '<td>';
        component += '<select style="width: 100% !important; min-width: 100% !important; max-width: 100% !important;" id="md_field_family_col_MemberBloodType_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col numeric chzn-select" column_name="MemberBloodType" >';
        ...
        component += '<td>';
        component += '<input id="md_field_family_col_MemberKTP_'+RECORD_INDEX_family+'" record_index="'+RECORD_INDEX_family+'" class="md_field_family_col form-control numeric" column_name="MemberKTP" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        // Delete Button
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        component += '<td class="text-center"><span class="delete-icon btn btn-danger btn-xs md_field_family_delete" record_index="'+RECORD_INDEX_family+'"><i class="glyphicon glyphicon-remove"></i></span></td>';
        component += '</tr>';
    ...
    function mutate_input_family(){
        ...
        // datetime-input
        $('#md_table_family .datetime-input').datetimepicker({
            timeFormat: 'HH:mm:ss',
            dateFormat: js_date_format,
            showButtonPanel: true,
            changeMonth: true,
        ...
        // chzn-select
        $("#md_table_family .chzn-select").chosen();
        // numeric
