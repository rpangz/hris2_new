...
echo"<table>
  <tr>
    ...
    <option value='http://$_SERVER[SERVER_NAME]/hris2/master/division/index/0'>---ALL---</option>";
    ...
    if($this->uri->segment('4')==$data['iCompanyId']){  
      echo "<option value='http://$_SERVER[SERVER_NAME]/hris2/master/division/index/$data[iCompanyId]' SELECTED>$data[cCompanyName]</option>";
    }
    else {
      echo "<option value='http://$_SERVER[SERVER_NAME]/hris2/master/division/index/$data[iCompanyId]'>$data[cCompanyName]</option>";
    }
