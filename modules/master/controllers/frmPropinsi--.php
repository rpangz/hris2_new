...
class frmPropinsi extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->columns('cCompanyName','cCompanyCode');
		
		
        // displayed columns on edit operation
       
		$crud->edit_fields('cCompanyName','cCompanyCode');

		
        // displayed columns on add operation
		
		$crud->add_fields('cCompanyName','cCompanyCode');
		...
		$crud->required_fields('cCompanyName','cCompanyCode');
