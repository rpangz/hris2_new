 ...
 */
class frmDesa extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->set_table($this->cms_complete_table_name('desa'));
        ...
        $crud->columns('KDDESA','NMDESA','KDKEC','KDDATI2','KDPROP');
        $crud->edit_fields('KDPROP','KDDATI2','KDKEC','KDDESA','NMDESA');
        $crud->add_fields('KDPROP','KDDATI2','KDKEC','KDDESA','NMDESA');
            
       
        $crud->display_as('KDDESA','Kode');
        ...
        $crud->required_fields('KDDESA','KDPROP','KDDATI2','KDKEC','KDDESA','NMDESA');
        ...
        $crud->set_relation('KDKEC', $this->cms_complete_table_name('kec'), 'NMKEC');
        ...
        $crud->callback_column('NMDESA',array($this,'_callback_webpage_url'));
        ...
        $crud->callback_add_field('KDKEC', array($this, 'empty_city_dropdown_select'));
        $crud->callback_edit_field('KDKEC', array($this, 'empty_city_dropdown_select'));
    ...
    public function _example_output($output = null)
    {
        ...
        $this->view($this->cms_module_path().'/frmDesa_view', $output,
        $this->cms_complete_navigation_name('frmDesa'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_dropdowns' => array('KDPROP','KDDATI2','KDKEC'),
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url' => array('', site_url().'/master/frmDesa/get_states/', site_url().'/master/frmDesa/get_cities/'),
        ...
        if(!$crud->unset_delete){
            ...
            foreach($id_list as $id){
                if($this->_before_delete($id)){
                    $this->db->delete($this->cms_complete_table_name('desa'),array('KDDESA'=>$id));
    ...
    public function _callback_webpage_url($value, $row){        
        ...
        return "<a href='".site_url($this->cms_module_path().'/frmDesa/index/edit/'.$row->KDDESA)."'>$value</a>";
