 ...
 */
class frmRegencyCity extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        // table name
        $crud->set_table($this->cms_complete_table_name('mst_dati2'));
        //$crud->ORDER_BY('KDPROP','ASC');
        // primary key
        $crud->set_primary_key('KDDATI2');

        // set subject
        $crud->set_subject('Kab / Kota');
		...
		$crud->set_relation('KDPROP', $this->cms_complete_table_name('mst_propinsi'), 'NMPROP');
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/frmRegencyCity_view', $output,
            $this->cms_complete_navigation_name('frmRegencyCity'));
    }
        ...
        if(!$crud->unset_delete){
            ...
            foreach($id_list as $id){
                if($this->_before_delete($id)){
                    $this->db->delete($this->cms_complete_table_name('mst_dati2'),array('KDDATI2'=>$id));
