 ...
 */
class Company extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        // primary key
        $crud->set_primary_key('company_id');

        // set subject
        $crud->set_subject('Company');

        // displayed columns on list
		$crud->columns('company_name','company_code','description');
		
		
        // displayed columns on edit operation
       
		$crud->edit_fields('company_code','company_name','description');

		
        // displayed columns on add operation
		
		$crud->add_fields('company_code','company_name','description');
		


        // caption of each columns		
				
        $crud->display_as('company_code','Code');
		...
		$crud->unique_fields('company_code','company_name');
        ...
        $crud->callback_column('company_name',array($this,'_callback_edit_url'));
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/Company_view', $output,
            $this->cms_complete_navigation_name('company'));
    }
    ...
    public function _callback_edit_url($value, $row){    
        ...
        return "<a href='".site_url($this->cms_module_path().'/'.$this->uri->segment('2').'/index/edit/'.$row->company_id)."'>$value</a>";
