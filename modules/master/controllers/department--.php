...
class Department extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->columns('iDeptDivID','cDeptCode','cDeptName','tDeptRemarks','bDeptStatus');
        // displayed columns on edit operation
        $crud->edit_fields('iDeptDivID','cDeptCode','cDeptName','tDeptRemarks','bDeptStatus');
        // displayed columns on add operation
        $crud->add_fields('iDeptDivID','cDeptCode','cDeptName','tDeptRemarks','bDeptStatus');
		...
		$crud->display_as('iDeptDivID','Divisi');
        //$crud->display_as('iDeptID','Departement');
        $crud->display_as('cDeptCode','Code');
        $crud->display_as('cDeptName','Name');
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $crud->set_relation('iDeptDivID', $this->cms_complete_table_name('division'), 'cDivName');
        ...
        if(!$crud->unset_delete){
            ...
            foreach($id_list as $id){
                if($this->_before_delete($id)){
                    $this->db->delete($this->cms_complete_table_name('department'),array('iDeptID'=>$id));
