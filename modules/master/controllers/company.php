...
class Company extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->columns('iCompanyId','cCompanyName','cCompanyCode','bStatus');
        ...
        if(!$crud->unset_delete){
            ...
            foreach($id_list as $id){
                if($this->_before_delete($id)){
                    $this->db->delete($this->cms_complete_table_name('company'),array('iCompanyId'=>$id));
