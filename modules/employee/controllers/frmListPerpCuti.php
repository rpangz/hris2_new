...
class frmListPerpCuti extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/kehadiran/frmListPerpCuti/get_states/', site_url().'/kehadiran/frmListPerpCuti/get_nik1/', site_url().'/kehadiran/frmListPerpCuti/get_companyID/'),
