...
/**
 * Installation script for employee
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.employee';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Employee',
            $module_path.'/employee', $this->PRIV_EVERYONE);
