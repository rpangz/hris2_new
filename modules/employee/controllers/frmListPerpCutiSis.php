 ...
 */
class frmListPerpCutiSis extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->where('tbl_formperpcuti.companyID', 2);
		...
		$crud->columns('NIK','NIKKI','HakCutiId','CreatedTime','StatusForm');
		...
		$crud->required_fields('NIK','HakCutiId','companyID','NIK1','NIK2','Apv1','Apv2','StatusForm');
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmListPerpCutiSis_view', $output,
        $this->cms_complete_navigation_name('frmListPerpCutiSis'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/kehadiran/frmListPerpCutiSis/get_states/', site_url().'/kehadiran/frmListPerpCutiSis/get_nik1/', site_url().'/kehadiran/frmListPerpCutiSis/get_companyID/'),
