...
class frmListFormIjinSis extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->set_relation('NIK2', $this->cms_complete_table_name('apv_hrd'), '{hrd_name}',array('hrd_status' => 1, 'hrd_company' => 2));
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/kehadiran/frmListFormIjinSis/get_states/', site_url().'/kehadiran/frmListFormIjinSis/get_cities/'),
