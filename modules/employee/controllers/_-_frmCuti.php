...
class frmCuti extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        // table name
        $crud->set_table($this->cms_complete_table_name('p3k'));
        ...
        // set subject
        $crud->set_subject('P3K');

        

        // displayed columns on list
        $crud->columns('NIK','Name','Grade','Status','Jobs','Company','Division','Departement','Location','StartingDate','KKWT');
        // displayed columns on edit operation
        $crud->edit_fields('NIK','Name','Grade','Status','Jobs','Company','Division','Departement','Penempatan','Location','StartingDate','Remark','KKWT');
        // displayed columns on add operation
        $crud->add_fields('NIK','Name','Grade','Status','Jobs','Company','Division','Departement','Penempatan','Location','StartingDate','Remark','KKWT');
        ...
        $crud->display_as('Grade','Grade');
        
        $crud->display_as('Status','Status');
        $crud->display_as('Jobs','Jobs');
        $crud->display_as('Company','Company');
        //$crud->display_as('commodity','Commodity');
        $crud->display_as('Division','Division');
        $crud->display_as('Departement','Departement');
        $crud->display_as('StartingDate','Starting Date');
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $crud->required_fields('NIK','Name','Grade','Status','Jobs','Company','Division','Departement','Location','StartingDate');
        ...
        $crud->callback_column('KKWT',array($this, '_callback_column_citizen'));
        $crud->callback_field('KKWT',array($this, '_callback_field_citizen'));
        ...
        //$crud->callback_column('budget_detail',array($this, '_callback_column_budget_detail'));
        ...
        if(!$crud->unset_delete){
            ...
            foreach($id_list as $id){
                if($this->_before_delete($id)){
                    $this->db->delete($this->cms_complete_table_name('frmCuti'),array('NIK'=>$id));
    ...
    public function _before_delete($primary_key){
        ...
        $this->db->delete($this->cms_complete_table_name('kkwt'),
    ...
    public function _after_insert_or_update($post_array, $primary_key){
        ...
        $real_column_names = array('KKWTId','NIK','KKWT_Name','KKWT_Date1','KKWT_Date2','active_id');
        ...
        foreach($delete_records as $delete_record){
            ...
            $this->db->delete($this->cms_complete_table_name('kkwt'),
                 array('KKWTId'=>$detail_primary_key));
        }
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //  UPDATED DATA
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        foreach($update_records as $update_record){
            ...
            $this->db->update($this->cms_complete_table_name('kkwt'),
                 $data, array('KKWTId'=>$detail_primary_key));
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        foreach($insert_records as $insert_record){
            ...
            $data['NIK'] = $primary_key;
            $this->db->insert($this->cms_complete_table_name('kkwt'), $data);
    ...
    public function _callback_field_citizen($value, $primary_key){
        ...
        $query = $this->db->select('KKWTId,NIK,KKWT_Name,KKWT_Date1,KKWT_Date2,active_id')
            ->from($this->cms_complete_table_name('kkwt'))
