...
class frmCuti extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        if ($listingID !=3){
            $crud->add_fields('FormCutiNIK','JenisCuti','HakCutiId','Keperluan','Alamat','NIKPengganti','NoTelpon','Detail','TglMasuk','NIK1','NIK2','NIK3','CreatedBy','CreatedTime','UpdatedTime','companyID');
        }
        else {
            $crud->add_fields('FormCutiNIK','JenisCuti','HakCutiId','Keperluan','Alamat','NIKPengganti','NoTelpon','TglActive1','TglActive2','TglMasuk','NIK1','NIK2','NIK3','CreatedBy','CreatedTime','UpdatedTime','companyID');
        }
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
        ...
        $crud->set_relation('NIK3', $this->cms_complete_table_name('apv_hrd'), '{hrd_name} [{hrd_email}]',array('hrd_status' =>1,'hrd_company' => $hrd_company));
    ...
    public function _after_insert($post_array, $primary_key){
        ...
        */
        ...
        if($num_row > 0 || $total >0){
            ...
            echo "<script language='javascript'>alert('Data Sudah Disimpan dan Email sudah dikirim...$num_row , $total');history.go(-1);</script>";  
