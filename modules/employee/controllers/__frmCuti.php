...
class frmCuti extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->columns('FormCutiNIK','TglActive1','TglActive2','Keperluan','StatusForm','citizen');
		
		
        // displayed columns on edit operation
       
		$crud->edit_fields('FormCutiNIK','TglActive1','TglActive2','Keperluan','Alamat','NoTelpon','iNIK1','citizen');
        $crud->add_fields('FormCutiNIK','JenisCuti','TglActive1','TglActive2','Keperluan','Alamat','NoTelpon','citizen','iNIK1','iNIK2','iNIK3');
		...
		$crud->required_fields('FormCutiNIK','TglActive1','TglActive2','Keperluan','Alamat','NoTelpon','iNIK1','iNIK2','iNIK3','iNIK4');
        ...
        $crud->field_type('iNIK3','dropdown',
            array('4833' => 'Dompak Petrus Sinambela [dompak.sinambela@unias.com]', 
   ...
   public function _after_insert_or_update($post_array, $primary_key){
        ...
        $real_column_names = array('DetailCutiId, CutiId, TglCuti, IsAllocate');
        $set_column_names = array();
        $many_to_many_column_names = array('twn_hobby');
        $many_to_many_relation_tables = array('citizen_hobby');
        $many_to_many_relation_table_columns = array('DetailCutiId');
    ...
    public function _callback_field_citizen($value, $primary_key){
        ...
        $query = $this->db->select('DetailCutiId,CutiId,TglCuti,IsAllocate')
        ...
        for($i=0; $i<count($result); $i++){
            $query_detail = $this->db->select('hobby_id')
               ...
               ->where(array('DetailCutiId'=>$result[$i]['DetailCutiId']))->get();
            $value = array();
