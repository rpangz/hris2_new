...
$NIK = $this->uri->segment('4');
  ...
  if (!is_null($this->input->get('nik'))){
      ...
      $arr  = explode(" ",$name);
      $nik = $arr[0];
      $sSQL    = mysql_query("SELECT * FROM tbl_profile WHERE NIK='$nik' AND CompanyId ='2'");
...
<?php  include "includes/frmListSejarahCutiSis.php";?>
...
<script src="http://<?php echo $_SERVER['SERVER_NAME'];?>/hris2/includes/js/jquery-ui.js"></script>
 ...
 <script>
    ...
    function autocomplete(){
      $( ".auto" ).autocomplete({
       source: "http://<?php echo $_SERVER['SERVER_NAME'];?>/hris2/includes/SearchSis.php", 
         minLength:2,
      });
