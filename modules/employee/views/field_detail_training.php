...
<style type="text/css">
    ...
    #training_display_as_box{
        display: none;
    }
    #md_table_training{
        font-size: 12px;
    }
    #md_table_training textarea{
        width: 280px;
    }
...
<div id="md_table_training_container">
    ...
    <table id="md_table_training" class="table table-striped table-bordered row-border" style="display:none;">
        <thead>
            <tr>
                <th>Year</th>
                <th>Institution</th>
    ...
    <div class="fbutton">
        <span id="md_field_training_add" class="add btn btn-success btn-xs">
            <i class="glyphicon glyphicon-plus-sign"></i> Add Training </span>
    </div>
    <br />
...
<script type="text/javascript">
    ...
    function add_table_row_training(value){
        ...
        component += '<td>';
        component += '<input style="width: 60px;" id="md_field_training_col_TrainingYear_'+RECORD_INDEX_training+'" record_index="'+RECORD_INDEX_training+'" class="md_field_training_col form-control numeric" column_name="TrainingYear" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width:250px;" id="md_field_training_col_TrainingInstitution_'+RECORD_INDEX_training+'" record_index="'+RECORD_INDEX_training+'" class="md_field_training_col form-control" column_name="TrainingInstitution" type="text" placeholder="" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<select style="width: 100px !important; min-width: 100px; max-width: 100px;" id="md_field_training_col_TrainingCity_'+RECORD_INDEX_training+'" record_index="'+RECORD_INDEX_training+'" class="md_field_training_col form-control numeric chzn-select" column_name="TrainingCity" >';
        ...
        */       
        ...
        component += '<td>';
        component += '<input style="width:150px;" id="md_field_training_col_TrainingCity_'+RECORD_INDEX_training+'" record_index="'+RECORD_INDEX_training+'" class="md_field_training_col form-control" column_name="TrainingCity" type="text" placeholder="City of Training" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width:150px;" id="md_field_training_col_TrainingType_'+RECORD_INDEX_training+'" record_index="'+RECORD_INDEX_training+'" class="md_field_training_col form-control" column_name="TrainingType" type="text" placeholder="Soft Skill, Hard Skill dll" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<textarea rows="3" cols="10" id="md_field_training_col_TrainingModul_'+RECORD_INDEX_training+'" record_index="'+RECORD_INDEX_training+'" class="md_field_training_col form-control" column_name="TrainingModul" placeholder="Sebutkan modul trainingnya">'+field_value+'</textarea>';
        component += '</td>';
        ...
        if(field_value != '' && field_value != null){
            ...
            component += '<input id="md_field_training_col_TrainingFileUrl_'+RECORD_INDEX_training+
                  '" record_index="'+RECORD_INDEX_training+
                  '" class="md_field_training_col" column_name="TrainingFileUrl" type="file"'+
                  ' name="md_field_training_col_TrainingFileUrl_'+RECORD_INDEX_training+'" value="'+field_value+'"/>';
        }
        ...
        // Delete Button
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        component += '<td><span class="delete-icon btn btn-danger btn-xs md_field_training_delete" record_index="'+RECORD_INDEX_training+'"><i class="glyphicon glyphicon-trash"></i></span></td>';
        component += '</tr>';
    ...
    function mutate_input_training(){
        ...
        // datetime-input
        $('#md_table_training .datetime-input').datetimepicker({
            timeFormat: 'HH:mm:ss',
            dateFormat: js_date_format,
            showButtonPanel: true,
            changeMonth: true,
