  ...
  <div id="tfheader">
    ...
    <form id="tfnewsearch" method="get" action="?">
      <table width="100%">
            <tr>
              <td>
                <input type="text" class="tftextinput" size="40" maxlength="100" autocomplete="off" placeholder="NIK or Name" name="nik"><input type="submit" value="search" class="tfbutton">
              </td>
...
<?php  
  ...
  include "./includes/frmListSejarahCutiGroup.php";
...
<script src="http://<?php echo $_SERVER['SERVER_NAME'];?>/hris2/includes/js/jquery-ui.js"></script>
 ...
 <script>
    ...
    function autocomplete(){
      $( ".auto" ).autocomplete({
       source: "http://<?php echo $_SERVER['SERVER_NAME'];?>/hris2/includes/SearchGroup.php", 
         minLength:2,
      });
