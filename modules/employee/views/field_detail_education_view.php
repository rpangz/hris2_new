...
<div id="md_table_education_container">
    ...
    <div class="fbutton">
        <span id="md_field_education_add" class="add btn btn-success btn-sm">
...
<script type="text/javascript">
    ...
    function add_table_row_education(value){
        ...
        component += '<td>';
        if(field_value != ''){
            component += '<a href="'+UPLOAD_PATH+field_value+'" class="btn btn-sm btn-primary" target="_blank"><i class="glyphicon glyphicon-download-alt"</i></a>';
        }else{
        ...
        // Delete Button
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        component += '<td><span class="delete-icon btn btn-danger btn-sm md_field_education_delete" record_index="'+RECORD_INDEX_education+'"><i class="glyphicon glyphicon-trash"></i></span></td>';
        component += '</tr>';
