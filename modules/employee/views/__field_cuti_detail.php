...
<script type="text/javascript">
    ...
    function add_table_row_citizen(value){
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('IsAllocate')){
          field_value = value.IsAllocate;
        }
        component += '<td>';
        component += '<select id="md_field_citizen_col_IsAllocate_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="IsAllocate" >';
        var options = OPTIONS_citizen.IsAllocate;
