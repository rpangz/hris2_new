...
echo"<div class='alert alert-info'>
  ...
  <tr>
    ...
    if($this->uri->segment('4')==$data['id']){  
      echo "<option value='http://$_SERVER[SERVER_NAME]/hris2/employee/frmCuti/index/$data[id]' SELECTED>$data[JenisCutiName]</option>";
    }
    else {
      echo "<option value='http://$_SERVER[SERVER_NAME]/hris2/employee/frmCuti/index/$data[id]'>$data[JenisCutiName]</option>";
    }
