...
/**
 * Installation script for media_blulok
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.media_blulok';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Media Blulok',
            $module_path.'/media_blulok', $this->PRIV_EVERYONE);
