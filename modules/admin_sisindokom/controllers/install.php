...
/**
 * Installation script for admin_sisindokom
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_sisindokom';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Sisindokom',
            $module_path.'/admin_sisindokom', $this->PRIV_EVERYONE);
