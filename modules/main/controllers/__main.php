...
class Main extends CMS_Controller
{
    ...
    public function check_registration(){
        if ($this->input->is_ajax_request()){
            ...
            */
            ...
            $data = array(
                "exists" => $user_id_exists || $user_name_exists || $email_exists,
                "error" => $error,
                "message" => $message
            );
    ...
    public function user()
    {
        ...
        $crud->columns('user_id','user_name', 'email', 'real_name', 'active', 'groups','dUserUpdateTime');
        $crud->edit_fields('user_id','user_name', 'email', 'real_name', 'active', 'groups');
        $crud->add_fields('user_id','user_name', 'email', 'password', 'real_name', 'active', 'groups');
                ...
                <ul class="nav pull-right navbar-nav">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> <i class="glyphicon glyphicon-chevron-down"></i></a>
                                    ...
                                    <li><a href="'.site_url('karyawan/frmProfile/').'"><i class="fa fa-cog"></i>My Profile [{{ user_name }}]</a></li>
                                    <li><a href="'.site_url('main/change_profile/').'"><i class="fa fa-user"></i> Change Profile Login [{{ user_name }}]</a></li>
                                    <li class="divider"></li>
                                    <li><a href="'.site_url('main/logout/').'"><i class="fa fa-sign-out"></i> Logout [{{ user_name }}]</a></li>
                                    </ul>
                            </li>
                        </ul>';
            }
