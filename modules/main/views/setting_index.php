...
<script src="{{ site_url }}assets/jscolor/jscolor.js"></script>
...
<div id="div-body" class="tabbable"> <!-- Only required for left/right tabs -->
    <ul class="nav nav-tabs">
        ...
        <li><a href="#tab4" data-toggle="tab">Company</a></li>
        <li><a href="#tab5" data-toggle="tab">HRD Modules</a></li>
        <li><a href="#tab6" data-toggle="tab">Notifications</a></li>
    </ul>
    <form enctype="multipart/form-data" class="form form-horizontal" method="post">
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab1">
                ...
                <div class="form-group">
                    ...
                    <div class="controls col-md-8">
                        ...
                        <p class="help-block">Site name (e.g: example.com, My Company website, etc)</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <div class="controls col-md-8">
                          ...
                          <p class="help-block">Site footer &amp; attribution (e.g: "Powered by example.com © 2013", etc)</p>
                      </div>
                </div>
            ...
            <div class="tab-pane" id="tab2">
                <h3>Images</h3>
                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logo">Site Logo Astel Group</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logo'] ?>"><br>
                        <input type="file" id="site_logo" name="site_logo" class="form-control">
                        <p class="help-block">Image used as site Logo Astel (170 x 25 px)</p>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logosis">Site Logo Sisindokom</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logosis'] ?>"><br>
                        <input type="file" id="site_logosis" name="site_logosis" class="form-control">
                        <p class="help-block">Image used as site Logo Sisindokom (170 x 25 px)</p>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logojas">Site Logo Jasnikom</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logojas'] ?>"><br>
                        <input type="file" id="site_logojas" name="site_logojas" class="form-control">
                        <p class="help-block">Image used as site Logo Jasnikom (170 x 25 px)</p>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logomediatek">Site Logo Mediatek Solusindo</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logomediatek'] ?>"><br>
                        <input type="file" id="site_logomediatek" name="site_logomediatek" class="form-control">
                        <p class="help-block">Image used as site Logo Mediatek Solusindo (170 x 25 px)</p>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logodatacell">Site Logo Datacell</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logodatacell'] ?>"><br>
                        <input type="file" id="site_logodatacell" name="site_logodatacell" class="form-control">
                        <p class="help-block">Image used as site Logo Mediatek Datacell (170 x 25 px)</p>
                    </div>
                </div>
                

                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logoprovis">Site Logo Provis</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logoprovis'] ?>"><br>
                        <input type="file" id="site_logoprovis" name="site_logoprovis" class="form-control">
                        <p class="help-block">Image used as site Logo Provis (170 x 25 px)</p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4" for="site_logomediaindonusa">Site Logo Media Indonusa</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_logomediaindonusa'] ?>"><br>
                        <input type="file" id="site_logomediaindonusa" name="site_logomediaindonusa" class="form-control">
                        <p class="help-block">Image used as site Logo Media Indonusa (170 x 25 px)</p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4" for="site_background">Login Background</label>
                    <div class="controls col-md-8">
                        <img src="<?php echo $config_list['site_background'] ?>"><br>
                        <input type="file" id="site_background" name="site_background" class="form-control">
                        <p class="help-block">Image used as Login Background (size must be 1920 x 1440 pixel)</p>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tab4">
                <h3>Company Configurations</h3>               

                <div class="form-group cms_astel_id">
                    <label class="control-label col-md-4" for="cms_astel_id">Astel Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_astel_id" name="cms_astel_id" value="<?php echo $config_list['cms_astel_id'] ?>" class="form-control">
                        <p class="help-block">cms_astel_id</p>
                    </div>
                </div>

                <div class="form-group cms_sisindokom_id">
                    <label class="control-label col-md-4" for="cms_sisindokom_id">Sisindokom Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_sisindokom_id" name="cms_sisindokom_id" value="<?php echo $config_list['cms_sisindokom_id'] ?>" class="form-control">
                        <p class="help-block">cms_sisindokom_id</p>
                    </div>
                </div>

                <div class="form-group cms_jasnikom_id">
                    <label class="control-label col-md-4" for="cms_jasnikom_id">Jasnikom Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_jasnikom_id" name="cms_jasnikom_id" value="<?php echo $config_list['cms_jasnikom_id'] ?>" class="form-control">
                        <p class="help-block">cms_jasnikom_id</p>
                    </div>
                </div>

                <div class="form-group cms_mediaindonusa_id">
                    <label class="control-label col-md-4" for="cms_mediaindonusa_id">Media Indonusa Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_mediaindonusa_id" name="cms_mediaindonusa_id" value="<?php echo $config_list['cms_mediaindonusa_id'] ?>" class="form-control">
                        <p class="help-block">cms_mediaindonusa_id</p>
                    </div>
                </div>

                <div class="form-group cms_mediatek_id">
                    <label class="control-label col-md-4" for="cms_mediatek_id">Mediatek Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_mediatek_id" name="cms_mediatek_id" value="<?php echo $config_list['cms_mediatek_id'] ?>" class="form-control">
                        <p class="help-block">cms_mediatek_id</p>
                    </div>
                </div>

                 <div class="form-group cms_aryajaya_id">
                    <label class="control-label col-md-4" for="cms_aryajaya_id">Aryajaya Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_aryajaya_id" name="cms_aryajaya_id" value="<?php echo $config_list['cms_aryajaya_id'] ?>" class="form-control">
                        <p class="help-block">cms_aryajaya_id</p>
                    </div>
                </div>

                <div class="form-group cms_mediablulok_id">
                    <label class="control-label col-md-4" for="cms_mediablulok_id">Media Blulok Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_mediablulok_id" name="cms_mediablulok_id" value="<?php echo $config_list['cms_mediablulok_id'] ?>" class="form-control">
                        <p class="help-block">cms_mediablulok_id</p>
                    </div>
                </div>

                <div class="form-group cms_datacell_id">
                    <label class="control-label col-md-4" for="cms_datacell_id">Datacell Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_datacell_id" name="cms_datacell_id" value="<?php echo $config_list['cms_datacell_id'] ?>" class="form-control">
                        <p class="help-block">cms_datacell_id</p>
                    </div>
                </div>

                <div class="form-group cms_provis_id">
                    <label class="control-label col-md-4" for="cms_provis_id">Provis Id</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_provis_id" name="cms_provis_id" value="<?php echo $config_list['cms_provis_id'] ?>" class="form-control">
                        <p class="help-block">cms_provis_id</p>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tab5">
                ...
                <div class="form-group hrd_cuti_modules">
                    <label class="control-label col-md-4" for="hrd_cuti_modules">Cuti Modules</label>
                    <div class="controls col-md-8">
                        <input type="text" id="hrd_cuti_modules" name="hrd_cuti_modules" value="<?php echo $config_list['hrd_cuti_modules'] ?>" class="form-control">
                        <p class="help-block">hrd_cuti_modules</p>
                    </div>
                </div>

                <div class="form-group hrd_profile_modules">
                    <label class="control-label col-md-4" for="hrd_profile_modules">Profile Modules</label>
                    <div class="controls col-md-8">
                        <input type="text" id="hrd_profile_modules" name="hrd_profile_modules" value="<?php echo $config_list['hrd_profile_modules'] ?>" class="form-control">
                        <p class="help-block">hrd_profile_modules</p>
                    </div>
                </div>

                <div class="form-group hrd_bpjs_modules">
                    <label class="control-label col-md-4" for="hrd_bpjs_modules">BPJS Modules</label>
                    <div class="controls col-md-8">
                        <input type="text" id="hrd_bpjs_modules" name="hrd_bpjs_modules" value="<?php echo $config_list['hrd_bpjs_modules'] ?>" class="form-control">
                        <p class="help-block">hrd_bpjs_modules</p>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tab6">
                <h3>Notifications</h3>
                <div class="form-group">
                    <label class="control-label col-md-4" for="cms_notice_login">Notice Login Text</label>
                    <div class="controls col-md-8">
                        <textarea class="ckeditor" id="cms_notice_login" name="cms_notice_login"><?php echo $config_list['cms_notice_login'] ?></textarea>
                        <p class="help-block">Notice Login Text</p>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-4" for="cms_notice_login_color">Notice Login Font Color</label>
                    <div class="controls col-md-8">
                        <input type="text" id="cms_notice_login_color" name="cms_notice_login_color" value="<?php echo $config_list['cms_notice_login_color'] ?>" class="form-control color">
                        <p class="help-block">Notife Login Font Color</p>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-4" for="cms_notice_cuti_khusus">Notice Form Cuti Khusus/Ijin</label>
                    <div class="controls col-md-8">
                        <textarea class="ckeditor" id="cms_notice_cuti_khusus" name="cms_notice_cuti_khusus"><?php echo $config_list['cms_notice_cuti_khusus'] ?></textarea>
                        <p class="help-block">Notice Form Cuti Khusus/Ijin</p>
                    </div>
                </div>
