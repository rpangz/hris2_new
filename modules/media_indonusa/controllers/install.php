...
/**
 * Installation script for media_indonusa
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.media_indonusa';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Media Indonusa',
            $module_path.'/media_indonusa', $this->PRIV_EVERYONE);
