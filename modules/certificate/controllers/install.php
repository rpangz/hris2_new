...
/**
 * Installation script for approval
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.approval';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Approval',
            $module_path.'/approval', $this->PRIV_EVERYONE);
