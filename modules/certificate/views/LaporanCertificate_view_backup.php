...
if($this->uri->segment('8') =='' && $this->uri->segment('4') !='add' && $this->uri->segment('4') !='edit')  {
    ...
    <table class="form-group form-inline">
      ...
      <td style="padding-right: 10px; width: 300px;" >
        ...
        <select class="form-control" id="jenissertifikat" style="width: 150px; height: 30px; font-size: 12px;">        
            ...
            <option value="NON" <?php if($jenissertifikat=="NON"){echo "SELECTED";} ?> >NON CCIE</option>
            <option value="CCIE" <?php if($jenissertifikat=="CCIE"){echo "SELECTED";} ?> >CCIE</option>
        </select>
      </td>      
      </tr>
      <tr>
      ...
      <td style="width: 300px;">
        <input type="button" name="load" id="load" value="LOAD DATA" onclick="LoadData(jenissertifikat.value,tglfrom.value,tglto.value,company.value)" style="width: 90px; height: 25px; font-size: 11px;"> <input type="button" name="reset" id="reset" value="RESET" onclick="ResetData()" style="width: 90px; height: 25px; font-size: 11px;">
      </td>
...
<script type = "text/javascript">
    ...
    function LoadData(sertifikat,tglawalsertifikat,tglakhirsertifikat,company) {        
        ...
        hrefurl = hrefurl+"/"+sertifikat+"/"+tglawalsertifikat+"/"+tglakhirsertifikat+"/";
        window.location.href = hrefurl;
    }

     function ResetData() {        
        document.getElementById("jenissertifikat").value="ALL";
