...
/**
 * Installation script for global_development
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.global_development';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Global Development',
            $module_path.'/global_development', $this->PRIV_EVERYONE);
