...
/**
 * Installation script for admin_aryajaya
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_aryajaya';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Aryajaya',
            $module_path.'/admin_aryajaya', $this->PRIV_EVERYONE);
