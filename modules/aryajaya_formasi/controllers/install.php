...
/**
 * Installation script for aryajaya_formasi
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.aryajaya_formasi';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Aryajaya Formasi',
            $module_path.'/aryajaya_formasi', $this->PRIV_EVERYONE);
