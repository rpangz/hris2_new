...
/**
 * Installation script for admin_exceptastel
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_exceptastel';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Exceptastel',
            $module_path.'/admin_exceptastel', $this->PRIV_EVERYONE);
