...
class Summary_Result extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        $this->view($this->cms_module_path().'/summary_result_view', $output,
            $this->cms_complete_navigation_name('summary_result'));
    }
    ...
    public function filter_selection(){
        ...
        redirect($this->cms_module_path().'/summary_result/index/'.$CompanyID.'/'.$PeriodID,'refresh');
    ...
    public function _callback_column_Category($value, $row){


        return $this->Development_Model->set_nilai_akhir_pa($row->total_score);
