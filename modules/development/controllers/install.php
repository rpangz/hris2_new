...
/**
 * Installation script for development
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.development';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Development',
            $module_path.'/development', $this->PRIV_EVERYONE);
