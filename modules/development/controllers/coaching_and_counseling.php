...
class coaching_and_counseling extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->columns('cTitle','cDescription','CompanyID','DivisionID','DepartmentID');
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/coaching_and_counseling_view', $output,
            $this->cms_complete_navigation_name('coaching_and_counseling'));
    }    
    ...
    public function form_coaching_and_counseling($primary_key){

        $data = array(
            'session_nik' => $this->cms_user_id(),
        );

        echo $this->load->view($this->cms_module_path().'/form_coaching_and_counseling_view', $data ,TRUE);
