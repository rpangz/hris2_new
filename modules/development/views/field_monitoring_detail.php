...
<script type="text/javascript">
    ...
    function add_table_row_citizen(value){
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('iActivityID')){
          field_value = value.iActivityID;
        }
        component += '<td>';
        component += '<select id="md_field_citizen_col_iActivityID_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="iActivityID" >';
        var options = OPTIONS_citizen.iActivityID;
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('cDescription')){
          field_value = value.cDescription;
        }
        component += '<td>';
        component += '<input id="md_field_citizen_col_cDescription_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="cDescription" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('file_lampiran')){
            field_value = value.file_lampiran;
        }
        component += '<td>';
        if(field_value != ''){
            component += '<img src="'+UPLOAD_PATH+'thumb_'+field_value+'" />';
        }else{
            component += '<input id="md_field_citizen_col_file_lampiran_'+RECORD_INDEX_citizen+
                  '" record_index="'+RECORD_INDEX_citizen+
                  '" class="md_field_citizen_col" column_name="file_lampiran" type="file"'+
                  ' name="md_field_citizen_col_file_lampiran_'+RECORD_INDEX_citizen+'" value="'+field_value+'"/>';
        }
