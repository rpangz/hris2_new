...
<div id="md_table_performance_container">
    ...
    <table id="md_table_performance" class="table table-striped table-bordered table-hover" style="display:none;width:100%">
        <thead>
            <tr>            
                <th colspan="5">
                    <h4>A. PENILAIAN KINERJA OPERASIONAL (Bobot : 55 %)</h4>
                </th>
                <th colspan="10">
            ...
            <tr>
                ...
                <th rowspan="3" width="25%">
                    <div align="center">Area Kerja <a href="#" style="text-decoration: none;" class="glyphicon glyphicon-question-sign tip-top" data-toggle="tooltip" title="Yang menjadi job desc karyawan"></a></div>
                </th>
                <th rowspan="3" width="20%">
                    <div align="center">Target Kerja</div>
                </th>
                <th rowspan="3" width="3%" align="center" valign="middle">
                    <div align="center">Bobot (%)</div>
                </th>
                <th rowspan="3" width="30%">
                    <div align="center">Hasil yang Dicapai</div>
                </th>
                <th colspan="10">
                    <div align="center">Kategori Penilaian </div>
                </th>                
            </tr>
            <tr>                
                <th colspan="3" bgcolor="#00FF00">
                    <div align="center">Baik</div>
                </th>
                <th colspan="3" bgcolor="#FFFF00">
                    <div align="center">Cukup</div>
                </th>
                <th colspan="4" bgcolor="#FF9900">
                    <div align="center">Kurang</div>
                </th>
            </tr>
            <tr>
    ...
    <div>
        <span id="md_field_performance_add" class="add btn btn-default fbutton"><i class="glyphicon glyphicon-plus-sign"></i> Add Row </span>                         

        <span class="delete-icon btn btn-default md_field_performance_delete"><i class="glyphicon glyphicon-minus-sign"></i> Delete Row </span>
    ...
    <!--<textarea style="width: 100%; height: 300px;" id="md_real_field_performance_col" name="md_real_field_performance_col"></textarea>-->
</div>
...
<script type="text/javascript">
    ...
    function add_table_row_performance(value){
        ...
        component += '20<input id="md_field_performance_col_performance_weight_'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" class="md_field_performance_col" column_name="performance_weight" type="hidden" value="20"/>';
        component += '</div></td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_10'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="10" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_10'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_9'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="9" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_9'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_8'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="8" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_8'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_7'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="7" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_7'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_6'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="6" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_6'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_5'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="5" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_5'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_4'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="4" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_4'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_3'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="3" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_3'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_2'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="2" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_2'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="performance_value_'+RECORD_INDEX_performance+'" id="md_field_performance_col_radio_performace_1'+RECORD_INDEX_performance+'" record_index="'+RECORD_INDEX_performance+'" value="1" column_name="performance_value" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_performance_col_radio_performace_1'+RECORD_INDEX_performance+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
    ...
    $(document).ready(function(){
        ...
        $('.md_field_performance_delete').live('click', function(){
            ...
            //$('#md_field_performance_tr_'+record_index).remove();
    ...
    function current_value_prf(){
        ...
        //document.getElementById('total_time_result').value = 2.10;
        document.getElementById('total_time_result').value = <?php echo $this->development_model->calculate_rata_rata_time($session_nik,$periode); ?>; 
