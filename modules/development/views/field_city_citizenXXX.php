...
<div id="md_table_citizen_container">
    ...
    <table id="md_table_citizen" class="table table-striped table-bordered table-hover" style="display:none;width:100%">
        <thead>
           <tr>            
            <th colspan="5">               
            <div id="add_rows">
                ...
                <span class="delete-icon btn btn-default md_field_citizen_delete"><i class="glyphicon glyphicon-minus-sign"></i> Delete Row <span id="counter-del">0</span></span>
            </div>
            ...
            <tr>
                ...
                <th rowspan="3" width="35%"><div align="center">Hasil yang Dicapai</div></th>
    ...
    <!--<div class="fbutton">
        <span id="md_field_citizen_add" class="add btn btn-default"><i class="glyphicon glyphicon-plus-sign"></i> Add Row </span>
    </div>-->
...
<script type="text/javascript">
    ...
    function add_table_row_citizen(value){
        ...
        component += '<td>';
        component += '<textarea style="width: 100%; height: 100px;" id="md_field_citizen_col_performance_area_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col form-control" column_name="performance_area">'+field_value+'</textarea>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<textarea style="width: 100%; height: 100px;" id="md_field_citizen_col_performance_target_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col form-control" column_name="performance_target">'+field_value+'</textarea>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<textarea style="width: 100%; height: 100px;" id="md_field_citizen_col_performance_result_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col form-control" column_name="performance_result">'+field_value+'</textarea>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_10'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="10" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_10'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_9'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="9" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_9'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_8'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="8" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_8'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_7'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="7" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_7'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_6'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="6" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_6'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_5'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="5" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_5'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_4'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="4" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_4'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_3'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="3" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_3'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_2'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="2" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_2'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="radio_perf'+RECORD_INDEX_citizen+'" id="md_field_citizen_col_radio_performace_1'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" value="1" onclick="UpdateCostPerformance()" '+chk+'/><label for="md_field_citizen_col_radio_performace_1'+RECORD_INDEX_citizen+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
    ...
    $(document).ready(function(){
        ...
        $('#md_field_citizen_add').click(function(){
            ...
            if($("tr.md_field_citizen_tr").length<'<?php echo $max_data ?>')
        ...
        $('.md_field_citizen_delete').live('click', function(){
            ...
            var $tbody = $("#md_table_citizen tbody");
            var $last = $tbody.find('tr:last');
            // remove the component

            //$('#md_field_citizen_tr_'+last).remove();
