...
<div id="md_table_attitude_container">
    ...
    <table id="md_table_attitude" class="table table-striped table-bordered table-hover" style="display:none;width:100%">
        <thead>
            <tr>            
                <th colspan="4">           
                <h4>B. PENILAIAN SIKAP KERJA  (Bobot : 30 %)</h4>               
            ...
            <tr>
                ...
                <th rowspan="3" width="3%"><div align="center">Bobot (%)</div></th> 
                <th rowspan="3" width="45%"><div align="center">Definisi</div></th>                               
...
<script type="text/javascript">
    ...
    function add_table_row_attitude(value){
        ...
        component += '<td>';
        component += RECORD_INDEX_attitude+1;
        component += '</td>';
        ...
        component += '<input id="md_field_attitude_col_attitude_factor_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" class="md_field_attitude_col" column_name="attitude_factor" type="hidden" value="'+field_value+'"/>';
        component += '</td>';


        /////////////////////////////////////////////////////////////////////////////////////////////////////
        //    FIELD "attitude_weight"
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('attitude_weight')){
          field_value = value.attitude_weight;
        }
        component += '<td>';
        component += '<div align="center">30</div>';
        component += '<input id="md_field_attitude_col_attitude_weight_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" class="md_field_attitude_col" column_name="attitude_weight" type="hidden" value="30"/>';
        component += '</td>';
        ...
        component += '<input id="md_field_attitude_col_attitude_definition_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" class="md_field_attitude_col" column_name="attitude_definition" type="hidden" value="'+field_value+'"/>';
        component += '</td>';        
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_10_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="10" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_10_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_9_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="9" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_9_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_8_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="8" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_8_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_7_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="7" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_7_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_6_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="6" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_6_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_5_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="5" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_5_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_4_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="4" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_4_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_3_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="3" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_3_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_2_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="2" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_2_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<div align="center"><input type="radio" name="attitude_value_'+RECORD_INDEX_attitude+'" id="md_field_attitude_col_radio_attitude_1_'+RECORD_INDEX_attitude+'" record_index="'+RECORD_INDEX_attitude+'" value="1" column_name="attitude_value" onclick="UpdateCostAttitude()" '+chk+'/><label for="md_field_attitude_col_radio_attitude_1_'+RECORD_INDEX_attitude+'"><span class="fa-stack"><i class="fa fa-circle-o fa-stack-1x"></i><i class="fa fa-circle fa-stack-1x"></i></span></label></div>';
        component += '</td>';
    ...
    $(document).ready(function(){
        ...
        $('#md_field_attitude_add').click(function(){
            ...
            data.attitude_factor = '';
            data.attitude_definition = '';
            data.attitude_weight = '';
            data.attitude_value = '';
    ...
    function UpdateCostAttitude() {
        ...
        var max_data = <?php echo $max_data ?>;
        ...
        else if(grand_total_bulat <=4.00){
            document.getElementById('pointA').innerHTML = '';
            document.getElementById('pointB').innerHTML = '';
