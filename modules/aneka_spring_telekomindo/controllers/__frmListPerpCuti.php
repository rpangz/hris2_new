 ...
 */
class frmListPerpCutiJas extends CMS_Priv_Strict_Controller {
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmListPerpCutiJas_view', $output,
        $this->cms_complete_navigation_name('frmListPerpCutiJas'));    
    }
