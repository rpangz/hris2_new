...
*/
        ...
        elseif ($this->uri->segment(4) ==3){
            ...
            if (!empty($itemIDa) || !is_null($itemIDa)){
                ...
                $crud->field_type('JenisItemCuti','hidden',$itemIDa);                
                $crud->add_fields('JenisCuti','FormCutiNIK','JenisItemCuti','JenisItemCuti2','LocationCuti','Keperluan','Alamat','NoTelpon','NIKPengganti','TglActive1','TglActive2','Detail','TglMasuk','Files','NIK1','NIK2','NIK3','CreatedBy','CreatedTime','UpdatedTime','companyID');
    ...
    public function get_item(){
        ...
        foreach($db->result() as $row):
            ...
            $array[] = array("value" => '?nik='.$FormCutiNIK.'&item='.$row->JenisItemCutiId ,"property" => $row->JenisItemCutiName);
    ...
    {          
        ...
        $empty_select = '<select id="select" name="JenisItemCuti2" onchange=goToPage("select") class="chosen-select" data-placeholder="Select Jenis Ijin" style="width: 500px; display: none;">';
        $empty_select_closed = '</select>';
