...
//echo preg_replace_callback('/(<option[^<>]*>)(.*?)(<\/option>)/si', '__ommit_nbsp', $output);
 ...
 //echo base_url('includes/Search.php?com='.$company_id);
?>
...
<script type="text/javascript" src="<?php echo base_url('includes/js/jquery-1.8.3.js'); ?>"></script>
...
<script type="text/javascript">
    ...
    function autocomplete(){
      $( ".auto" ).autocomplete({
       source: "<?php echo base_url('includes/Search.php?com='.$company_id); ?>", 
         minLength:2,
      });
