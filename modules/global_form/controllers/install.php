...
/**
 * Installation script for global_form
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.global_form';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Global Form',
            $module_path.'/global_form', $this->PRIV_EVERYONE);
