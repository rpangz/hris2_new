...
/**
 * Installation script for general_form
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.general_form';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'General Form',
            $module_path.'/general_form', $this->PRIV_EVERYONE);
