...
/**
 * Installation script for admin_astel
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_astel';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Astel',
            $module_path.'/admin_astel', $this->PRIV_EVERYONE);
