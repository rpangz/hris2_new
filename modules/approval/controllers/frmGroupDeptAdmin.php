...
class frmGroupDeptAdmin extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->columns('iGroupApprovalListId','NIK','NIKKI','deptID','divisionID','companyID','potential','active_sub');
        $crud->edit_fields('companyID','divisionID','deptID','iGroupApprovalListId','NIK','potential','active_sub');
        $crud->add_fields('companyID','divisionID','deptID','iGroupApprovalListId','NIK');
        ...
        $crud->required_fields('deptID','iGroupApprovalListId','NIK');
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/approval/frmGroupApproval/get_states/', site_url().'/approval/frmGroupApproval/get_cities/'),
