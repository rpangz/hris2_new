...
/**
 * Installation script for report
 *
...
class Install extends CMS_Module_Installer {
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Report',
            $module_path.'/report', $this->PRIV_EVERYONE);
