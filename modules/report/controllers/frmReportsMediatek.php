...
class frmReportsMediaIndonusa extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        $hrd_modules = $this->cms_get_config('hrd_report_modules');
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/frmReportsMediaIndonusa_view', $output,
            $this->cms_complete_navigation_name('frmReportsMediaIndonusa'));
    }
