...
*/       
    ...
    public function ajax_load_data(){
        ...
        $corequery = 'SELECT a.companyid,deptid,DivisiId,cCompanyName,cCompanyCode,
                      ...
                      CASE WHEN cDeptName IS NULL THEN "" ELSE cDeptName END cDeptName,nik,nama,noKTP,tgllahir,tptlahir,DATE_FORMAT(tglmasuk,"%d/%m/%Y") AS tglmasuk,BandSkrg,Grade,NamaJabatan,StatusName,CASE WHEN a.bstatus = 1 THEN "ACTIVE" ELSE "NON ACTIVE" END bstatus
                      FROM tbl_profile a
                      ...
                      WHERE 1=1 '.$connscr.'
                      ORDER BY cCompanyCode,cDivName,cDeptName,nik
                      ';
        ...
        if($jenis=="detail"){
            if($grouping<>'all'){
                ...
                {       
                        ...
                        $loaddatadetail .= '<tr><td colspan=11 style="font-weight:bold; text-align: center">Total Karyawan: </td><td style="text-align:right; font-weight:bold; padding-right: 5px;">'.$grouptotal.'</td></tr>';
