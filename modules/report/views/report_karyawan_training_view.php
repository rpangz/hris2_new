...
$crud = new report_karyawan_training();
  ...
  ?>   
    <table class="table table-striped" style="font-size:12px;width:75%;table-layout:fixed">
        <tr>
            ...
            <td width="37%">
              <select name="grouping" id="grouping" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 11px; height: 30px;">
                ...
                <option value="TrainingYear"> TAHUN </option>            
               </select>
            </td>
            <td width="7%"><div align="left"></div></td>
        ...
        <tr>
            ...
            <td width="7%"><div align="left"></div></td>
            <td width="10%" class="noborder-lr" valign="middle">Status</td>
            <td width="2%" class="noborder-lr"><div align="center">:</div></td>
            <td width="37%">
              <select name="statusaktif" id="statusaktif" class="chosen-select form-control" data-placeholder="Pilih Status" style="width: 100%; font-size: 11px; height: 30px;">
                <option value="all">ALL</option>
        ...
        <tr>
            <td width="12%" class="noborder-lr" valign="middle">Tahun</td>
            <td width="2%" class="noborder-lr"><div align="center">:</div></td>
            <td width="37%" colspan="1">                
                <select name="tahun1" id="tahun1" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 11px; height: 30px;">
                <option value="0" selected="selected">ALL</option>
                    <?php echo $year ?>
               </select>          
            </td>
...
$( document ).ready(function() {
    ...
    $("#load").click(function(e){    
        ...
        */
        ...
        $.ajax({
            url : "<?php echo site_url('report/report_karyawan_training/ajax_load_data/')?>/?jenis="+jenis+"&grouping="+grouping+"&company="+company+"&divisi="+divisi+"&department="+department+"&tahun1="+tahun1+"&statusaktif="+statusaktif,
            type: "GET",            
