...
$crud = new report_karyawan_mutasi();
  ...
  ?>   
    <table class="table table-striped" style="font-size:12px;width:75%;table-layout:fixed">
        <tr>
            ...
            <td width="37%">
              <select name="grouping" id="grouping" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 11px; height: 30px;">
                ...
                <option value="mutasi_name"> JENIS MUTASI </option>
                <option value="companynamelama"> OLD COMPANY </option>
                <option value="companynamebaru"> NEW COMPANY </option>
        ...
        <tr>
            ...
            <td width="7%"><div align="left"></div></td>
            <td width="12%" class="noborder-lr" valign="middle">Jenis Mutasi</td>
            <td width="2%" class="noborder-lr"><div align="center">:</div></td>
            <td width="37%">
              <select name="jenis_mutasi" id="jenis_mutasi" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 11px; height: 30px;"> 
                <option value="0">ALL</option>  
                <?php echo $jenis_mutasi ?>
               </select>
            </td>
        </tr>

        <tr>
            <td width="10%" class="noborder-lr" valign="middle">Tanggal Mutasi</td>
            <td width="2%" class="noborder-lr"><div align="center">:</div></td>
            <td width="37%">
              <div class="input-group">
                    <input type="text" class="form-control" placeholder="Start" id="tglfrom" />
                    <span class="input-group-addon"> S/D </span>
                    <input type="text" class="form-control" placeholder="End" id="tglto"/>
              </div>
            </td>
            <td width="7%"><div align="left"></div></td>
            <td width="10%" class="noborder-lr" valign="middle">&nbsp;</td>
            <td width="2%" class="noborder-lr"><div align="center">&nbsp;</div></td>
            <td width="37%">&nbsp;</td>
        </tr>
    </table>    
    ...
    <div style="width: 100%; text-align: center;">
        <label>LAPORAN DATA MUTASI KARYAWAN</label>
    </div>
...
$( document ).ready(function() {
    ...
    $("#load").click(function(e){    
        ...
        */
        ...
        $.ajax({
            url : "<?php echo site_url('report/report_karyawan_mutasi/ajax_load_data/')?>/?jenis="+jenis+"&grouping="+grouping+"&company="+company+"&jenis_mutasi="+jenis_mutasi+"&tglfr="+tglfr+"&tglto="+tglto,
            type: "GET",            
