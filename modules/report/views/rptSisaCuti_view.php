...
$link2excel = 'http://'.$_SERVER['SERVER_NAME'].'/hris2/includes/report/gen_rptSisaCuti.php?pt='.$this->input->get('pt').'&div='.$this->input->get('div').'&dept='.$this->input->get('dept').'&jc='.$this->input->get('jc');
        $link2pdf   = '#';
        }else{
        $link2excel = '';
        $link2pdf   = '';
...
<table class="table2" width="100%" border="0" cellspacing="0" cellpadding="5">
 ...
 <tr>
    <td scope="col">&nbsp;&nbsp;<?php include "includes/report/modul_pilih.php"; ?></td>
  ...
  <tr>
    <td colspan="2" scope="row"><div align="right"><input type="submit" class="btn btn-default" name="submit" value="Generate">   
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php
if (!is_null($this->input->get('pt')) && !is_null($this->input->get('div')) && !is_null($this->input->get('dept')) && !is_null($this->input->get('jc'))){
  include "includes/report/rpt_SisaCuti.php";
}
