...
echo'<table>
  ...
  <option value="" disabled SELECTED>Select Report</option>';
    ...
    if($this->uri->segment('4')== $data['ReportId']){  
      echo '<option value="http://'.$_SERVER['SERVER_NAME'].'/hris2/report/frmReportsJasnikom/index/'.$data['ReportId'].'" SELECTED>'.$data['ReportName'].'</option>';
    }
    else {
      echo '<option value="http://'.$_SERVER['SERVER_NAME'].'/hris2/report/frmReportsJasnikom/index/'.$data['ReportId'].'">'.$data['ReportName'].'</option>';
    }
