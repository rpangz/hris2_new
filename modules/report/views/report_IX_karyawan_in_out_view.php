...
$crud = new report_IX_karyawan_in_out();


  ?>   
    <table class="table table-striped" style="font-size:12px;width:45%;table-layout:fixed">
        <tr>
            ...
            <td width="20%">
              <select name="jenis" id="jenis" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 12px; height: 35px; ">
                <option value="inout" selected="">Laporan In Out</option>
        ...
        <tr>
            <td width="12%" class="noborder-lr" valign="middle">Bulan Report</td>
            <td width="2%" class="noborder-lr"><div align="center">:</div></td>
            <td >
                <!--
                ...
                -->
                <select name="blnproses" id="blnproses" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 12px; height: 35px; ">
                    <?php echo $blnproses; ?>
                </select>             
            </td>
            <td width="7%"><div align="left"></div></td>            
...
$( document ).ready(function() {
    ...
    $("#load").click(function(e){    
        ...
        */
        ...
        $.ajax({
            url : "<?php echo site_url('report/report_IX_karyawan_in_out/ajax_load_data/')?>/?jenis="+jenis+"&blnproses="+blnproses,
            type: "GET",            
