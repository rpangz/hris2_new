        ...
        <tr>
            ...
            <td width="37%">
              <select name="grouping" id="grouping" class="chosen-select form-control" data-placeholder="Pilih Perusahaan" style="width: 100%; font-size: 11px; height: 30px;">
                ...
                <option value="ketusia"> USIA </option>
               </select>
            </td>
            <td width="7%"><div align="left"></div></td>
...
$( document ).ready(function() {
    ...
    $("#load").click(function(e){    
        ...
        */
        ...
        $.ajax({
            url : "<?php echo site_url('report/report_karyawan_masuk/ajax_load_data/')?>/?jenis="+jenis+"&grouping="+grouping+"&company="+company+"&divisi="+divisi+"&department="+department+"&tglfr="+tglfr+"&tglto="+tglto+"&statusaktif="+statusaktif,
            type: "GET",            
