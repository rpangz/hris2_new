...
/**
 * Installation script for scheduled_task
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.scheduled_task';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Scheduled Task',
            $module_path.'/scheduled_task', $this->PRIV_EVERYONE);
