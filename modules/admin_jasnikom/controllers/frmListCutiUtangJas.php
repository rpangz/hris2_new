 ...
 */
class frmListCutiUtangJas extends CMS_Priv_Strict_Controller {
...
*/
        $crud->set_relation('NIK3', $this->cms_complete_table_name('apv_hrd'), '{hrd_name}',array('hrd_status' => 1,'hrd_company' => $company_id));
...
*/
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmListCutiUtangJas_view', $output,
        $this->cms_complete_navigation_name('frmListCutiUtangJas'));    
    }
       ...
       $query = $this->db->select('*')
        ...
        foreach($query->result() as $row):
            ...
            if ($num_row <=0 || $today < $row->Periode1 || $Sisa <=0){
                $empty_select = "<b>Tersedia</b><input type='hidden' maxlength='50' value='' name='HakCutiId'>";
            }
