...
/**
 * Installation script for admin_jasnikom
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_jasnikom';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Jasnikom',
            $module_path.'/admin_jasnikom', $this->PRIV_EVERYONE);
