 ...
 */
class frmMemberListSisindokom extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->columns('bpjs_Id','MotherNIK','MotherName','No_KK','No_KTP','Nama','PISA','Tempat_Lahir','Tgl_Lahir','Sex','Status_Kawin',
                            ...
                            'No_Passport','companyID','divisionID','deptID','aktif','CreateTime');
        ...
        $crud->edit_fields('MotherNIK','MotherName','No_KK','No_KTP','NIK','Nama','PISA','Tgl_Lahir','Tempat_Lahir','Sex','Status_Kawin',
                            ...
                            'Kelas_Rawat','TMT','Gaji','Kewarganegaraan','No_NPWP','NoBPJSKes','No_Passport',
                            'companyID','divisionID','deptID','Jabatan','Status_Karyawan','email','Nomor_Telp',
                            'No_Polis (Asuransi Lainnya)','Nama_Asuransi Lainnya','UpdateBy','UpdateTime','aktif');
        ...
        $crud->add_fields('MotherNIK','MotherName','No_KK','No_KTP','NIK','Nama','PISA','Tgl_Lahir','Tempat_Lahir','Sex','Status_Kawin',
                            ...
                            'companyID','divisionID','deptID','Jabatan','Status_Karyawan','email','Nomor_Telp','Asuransi_Lainnya','aktif');
    ...
    public function _example_output($output = null)
    {
        ...
        $this->view($this->cms_module_path().'/frmMemberListSisindokom_view', $output,
        $this->cms_complete_navigation_name('frmMemberListSisindokom'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/bpjs/frmMemberListSisindokom/get_states/', site_url().'/bpjs/frmMemberListSisindokom/get_cities/'),
        ...
        $dd_data2 = array(
                ...
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url2' => array('', site_url().'/bpjs/frmMemberListSisindokom/get_dati2/', site_url().'/bpjs/frmMemberListSisindokom/get_kec/', site_url().'/bpjs/frmMemberListSisindokom/get_desa/'),
                //LOADER THAT GETS DISPLAYED NEXT TO THE PARENT DROPDOWN WHILE THE CHILD LOADS
        ...
        $dd_data3 = array(
                ...
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url3' => array('', site_url().'/bpjs/frmMemberListSisindokom/get_KDFaskes_KDDATI2/', site_url().'/bpjs/frmMemberListSisindokom/get_KDFaskes/',site_url().'/bpjs/frmMemberListSisindokom/get_KDFaskesGigi/'),
                //LOADER THAT GETS DISPLAYED NEXT TO THE PARENT DROPDOWN WHILE THE CHILD LOADS
   ...
   //CALLBACK FUNCTIONS
    ...
    public function _callback_webpage_url($value, $row){        
        ...
        return "<a href='".site_url($this->cms_module_path().'/frmMemberListSisindokom/index/edit/'.$row->bpjs_Id)."'>$value</a>";
