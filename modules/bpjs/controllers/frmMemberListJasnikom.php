 ...
 */
class frmMemberListJasnikom extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        if (!is_null($listingID) && $listingID !=0){
            $data = mysql_fetch_array(mysql_query("SELECT * FROM tbl_periode WHERE iPeriodId = '$listingID'"));
            $date1 = $data['dPeriodStartDate'];
            $date2 = $data['dPeriodEndDate'];

        }
        elseif(is_null($listingID)){
            $date1 = date('Y-m-d');
            $date2 = date('Y-m-d');
...
/*
        if ($this->uri->segment(4)==1 && !is_null($this->uri->segment(4))){
            $date1 = '2014-12-01';
            $date2 = '2014-12-31';

        }
        elseif($this->uri->segment(4)==2 && !is_null($this->uri->segment(4))){
            $date1 = '2015-01-01';
            $date2 = '2015-01-31';

        }
        elseif($this->uri->segment(4)==3 && !is_null($this->uri->segment(4))){
            $date1 = '2015-02-01';
            $date2 = '2015-02-28';

        }

        elseif($this->uri->segment(4)==4 && !is_null($this->uri->segment(4))){
            $date1 = '2015-03-01';
            $date2 = '2015-03-31';

        }

        elseif($this->uri->segment(4)==0 && !is_null($this->uri->segment(4))){
            $date1 = '1975-01-01';
            $date2 = '2020-12-31';
...
*/
    ...
    if (!is_null($this->uri->segment(4)) || $this->uri->segment(4) ==0){

        $crud->where('CreateTime >=', $date1);
        $crud->where('CreateTime <=', $date2);
    }else{
        ...
        //$crud->unset_add_fields('UpdateBy','UpdateTime');
        ...
        //$crud->callback_column('KDFaskes_KDDATI2',array($this,'_callback_column_KDFaskes_KDDATI2'));

        //$crud->callback_column('KDFaskes',array($this,'_callback_column_KDFaskes'));
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmMemberListJasnikom_view', $output,
        $this->cms_complete_navigation_name('frmMemberListJasnikom'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/bpjs/frmMemberListJasnikom/get_states/', site_url().'/bpjs/frmMemberListJasnikom/get_cities/'),
        ...
        $dd_data2 = array(
                ...
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url2' => array('', site_url().'/bpjs/frmMemberListJasnikom/get_dati2/', site_url().'/bpjs/frmMemberListJasnikom/get_kec/', site_url().'/bpjs/frmMemberListJasnikom/get_desa/'),
                //LOADER THAT GETS DISPLAYED NEXT TO THE PARENT DROPDOWN WHILE THE CHILD LOADS
        ...
        $dd_data3 = array(
                ...
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url3' => array('', site_url().'/bpjs/frmMemberListJasnikom/get_KDFaskes_KDDATI2/', site_url().'/bpjs/frmMemberListJasnikom/get_KDFaskes/',site_url().'/bpjs/frmMemberListJasnikom/get_KDFaskesGigi/'),
                //LOADER THAT GETS DISPLAYED NEXT TO THE PARENT DROPDOWN WHILE THE CHILD LOADS
   ...
   //CALLBACK FUNCTIONS
    ...
    public function _callback_webpage_url($value, $row){        
        ...
        return "<a href='".site_url($this->cms_module_path().'/frmMemberListJasnikom/index/edit/'.$row->bpjs_Id)."'>$value</a>";
