...
<body>
  ...
  <p>Dear, '.$data['Nama'].'</p>
    <p>HRD telah melakukan update Profile Anda pada '.$today.'</p>

  <p><strong>Berikut Detail Perubahan Data Profile Anda</strong></p>
  ...
  <tr>
    <td class="header">Alamat  E -KTP</td>
    <td>:</td>
    <td>'.$data['AlamatKTP'].'</td>
  </tr>
  <tr>
    <td class="header">Alamat Domisili</td>
    <td>:</td>
    <td>'.$data['AlamatDomisili'].'</td>
  </tr>
  <tr>
