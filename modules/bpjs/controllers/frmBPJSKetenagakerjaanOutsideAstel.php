 ...
 */
class frmBPJSKetenagakerjaanOutsideAstel extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        if (!is_null($listingID) && $listingID !=0){
            ...
            $crud->where('tbl_profile.CompanyId', $listingID);
            $crud->where('tbl_profile.CompanyId !=',1);
            $crud->where('tbl_profile.CompanyId !=',2);

        }
        else{
          
            $crud->where('tbl_profile.CompanyId >=', 0);
            $crud->where('tbl_profile.CompanyId !=',1);
            $crud->where('tbl_profile.CompanyId !=',2);
        }

        //$crud->where('tbl_profile.CompanyId', $trigger);
        ...
        $crud->columns('NoKPJ','NoBPJSKes','NIK','Nama','TptLahir','TglLahir','Sex','StatusDiri','BloodType','NoNPWP','NoKTP','AlamatKTP','AlamatDomisili','NamaIbuKandung','CompanyId','DivisiID','DeptID','UnitID','SeksiID','EmailPribadi','bStatus','UpdatedTime');
        ...
        $crud->edit_fields('Photos','NoKTP','TglKTP','Nama','Sex','Agama','TglLahir','TptLahir','AlamatKTP','AlamatDomisili','Kodepos','Telp','Hp','BloodType','StatusDiri','NamaIbuKandung','NoNPWP','NoKPJ','NoBPJSKes','EmailPribadi','CompanyId','DivisiID','DeptID','UnitID','SeksiID','Email','UpdatedBy','UpdatedTime','bStatus','member');
...
*/
        ...
        $crud->add_fields('Photos','NIK','NoKTP','TglKTP','Nama','Sex','Agama','TglLahir','TptLahir','AlamatDomisili','Kodepos','Telp',
                            'Hp','EmailPribadi','AlamatKTP','StatusDiri','TglMenikah','TglMasuk','TglKeluar','BandSkrg','Status','JmlAnak',
                            'CompanyId','DivisiID','DeptID','UnitID','SeksiID','JabatanID','Email','bStatus');
        ...
        $crud->display_as('bStatus','Status Join Karyawan');
        ...
        $crud->required_fields('NIK','Nama','NoKTP','TglKTP','Sex','TglLahir','TptLahir','Agama','Status','AlamatKTP','AlamatDomisili','Hp','BloodType','StatusDiri','NamaIbuKandung','NoNPWP','NoKPJ','EmailPribadi','CompanyId','DivisiID','DeptID','UnitID','Email','TglMasuk','bStatus');
        ...
        // call function to manipulate the text for compability excel 
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmBPJSKetenagakerjaanOutsideAstel_view', $output,
        $this->cms_complete_navigation_name('frmBPJSKetenagakerjaanOutsideAstel'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/bpjs/frmBPJSKetenagakerjaanOutsideAstel/get_states/', site_url().'/bpjs/frmBPJSKetenagakerjaanOutsideAstel/get_cities/', site_url().'/bpjs/frmBPJSKetenagakerjaanOutsideAstel/get_units/',site_url().'/bpjs/frmBPJSKetenagakerjaanOutsideAstel/get_seksi/'),
    ...
    //include site_url('karyawan/controllers/email_frmProfile.php');
