 ...
 */
class frmMemberBPJSKetenagakerjaan extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        if ($state !='edit' AND $state != 'add' AND $state !='read'){
            ...
            $crud->set_relation('CompanyId', $this->cms_complete_table_name('company'), '{cCompanyName}',array('iCompanyId' =>1));
...
*/
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmMemberBPJSKetenagakerjaan_view', $output,
        $this->cms_complete_navigation_name('frmMemberBPJSKetenagakerjaan'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/bpjs/frmMemberBPJSKetenagakerjaan/get_states/', site_url().'/bpjs/frmMemberBPJSKetenagakerjaan/get_cities/', site_url().'/bpjs/frmMemberBPJSKetenagakerjaan/get_units/',site_url().'/bpjs/frmMemberBPJSKetenagakerjaan/get_seksi/'),
