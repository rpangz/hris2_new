 ...
 */
class frmMemberListDatacell extends CMS_Priv_Strict_Controller {
    ...
    public function _example_output($output = null)
    {
        ...
        $this->view($this->cms_module_path().'/frmMemberListDatacell_view', $output,
        $this->cms_complete_navigation_name('frmMemberListDatacell'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/bpjs/frmMemberListDatacell/get_states/', site_url().'/bpjs/frmMemberListDatacell/get_cities/'),
        ...
        $dd_data2 = array(
                ...
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url2' => array('', site_url().'/bpjs/frmMemberListDatacell/get_dati2/', site_url().'/bpjs/frmMemberListDatacell/get_kec/', site_url().'/bpjs/frmMemberListDatacell/get_desa/'),
                //LOADER THAT GETS DISPLAYED NEXT TO THE PARENT DROPDOWN WHILE THE CHILD LOADS
        ...
        $dd_data3 = array(
                ...
                //SETUP URL POST FOR EACH CHILD
                //List in order as per above
                'dd_url3' => array('', site_url().'/bpjs/frmMemberListDatacell/get_KDFaskes_KDDATI2/', site_url().'/bpjs/frmMemberListDatacell/get_KDFaskes/',site_url().'/bpjs/frmMemberListDatacell/get_KDFaskesGigi/'),
                //LOADER THAT GETS DISPLAYED NEXT TO THE PARENT DROPDOWN WHILE THE CHILD LOADS
   ...
   //CALLBACK FUNCTIONS
    ...
    public function _callback_webpage_url($value, $row){        
        ...
        return "<a href='".site_url($this->cms_module_path().'/frmMemberListDatacell/index/edit/'.$row->bpjs_Id)."'>$value</a>";
