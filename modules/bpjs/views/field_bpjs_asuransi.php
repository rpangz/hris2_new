...
<div id="md_table_citizen_container">
    ...
    <div class="fbutton">
        <span id="md_field_citizen_add" class="add btn btn-default">
            <i class="glyphicon glyphicon-plus-sign"></i> Add Asuransi Lainnya        </span>
    </div>
    <br />
...
<script type="text/javascript">
    ...
    for(var i=0; i<old_data.length; i++){
        var row = old_data[i];
        var record_index = i;
        var primary_key = row['asuransi_id'];
        var data = row;
        delete data['asuransi_id'];
    ...
    function add_table_row_citizen(value){
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('asuransi_no')){
          field_value = value.asuransi_no;
        }
        component += '<td>';
        component += '<input id="md_field_citizen_col_name_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="asuransi_no" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        var field_value = '';
        if(typeof(value) != 'undefined' && value.hasOwnProperty('asuransi_name')){
          field_value = value.asuransi_name;
        }
        component += '<td width=70%>';
        component += '<input id="md_field_citizen_col_name_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="asuransi_name" type="text" value="'+field_value+'"/>';
        component += '</td>';
