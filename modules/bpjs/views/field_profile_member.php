...
<script type="text/javascript">
    ...
    function add_table_row_citizen(value){
        ...
        component += '<td>';
        component += '<input style="width: 250px;" id="md_field_citizen_col_MemberName_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberName" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width: 120px;text-transform: capitalize;" id="md_field_citizen_col_MemberTempatLahir_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberTempatLahir" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<select style="width: 120px !important; min-width: 120px; max-width: 120px;" id="md_field_citizen_col_MemberSex_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col numeric chzn-select" column_name="MemberSex" >';
        ...
        component += '<td>';
        component += '<input style="width: 30px;text-transform:uppercase;text-align:center;" id="md_field_citizen_col_MemberBloodType_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberBloodType" type="text" value="'+field_value+'"/>';
        component += '</td>';
        ...
        component += '<td>';
        component += '<input style="width: 150px;" id="md_field_citizen_col_MemberKTP_'+RECORD_INDEX_citizen+'" record_index="'+RECORD_INDEX_citizen+'" class="md_field_citizen_col" column_name="MemberKTP" type="text" value="'+field_value+'"/>';
        component += '</td>';
