...
/**
 * Installation script for datacell
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.datacell';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Datacell',
            $module_path.'/datacell', $this->PRIV_EVERYONE);
