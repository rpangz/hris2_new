...
echo"<table>
  <tr>
    ...
    <option value='https://$_SERVER[SERVER_NAME]/hris2/kehadiran/frmAttendance2/index/0'>---ALL Year ".$current_year."---</option>";
    ...
    if($this->uri->segment('4')==$data['iPeriodId']){  
      echo "<option value='https://$_SERVER[SERVER_NAME]/hris2/kehadiran/frmAttendance2/index/$data[iPeriodId]' SELECTED>$data[cPeriodName]</option>";
    }
    else {
      echo "<option value='https://$_SERVER[SERVER_NAME]/hris2/kehadiran/frmAttendance2/index/$data[iPeriodId]'>$data[cPeriodName]</option>";
    }
...
echo'<table id="tfhover" class="tftableon" width="100%" border="1" cellspacing="1" cellpadding="1">
        ...
        <th colspan="12" width="3%"><div align=right>
            <div class="social">
            <ul>
              <li><a onclick="return false;" class="north" href="http://'.$_SERVER['SERVER_NAME'].'/hris2/includes/export/frmAtt/exp_frmAtt.php?NIK='.$session_nik.'&PRD='.$periode_id.'" target="_blank" title="Download Excel"><img src="http://'.$_SERVER['SERVER_NAME'].'/hris2/images/icn-excel.png" alt="Download Excel" width="25" class="img-responsive"/></a></li>              
            </ul>
        </div>
        </th>
        </tr>        
