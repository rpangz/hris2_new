...
echo '<br/><a href="https://'.$_SERVER['SERVER_NAME'].'/hris2/kehadiran/frmSejarahRawatJalan/index/?act=default&p='.$_GET['p'].'" class="btn btn-primary" role="button">&nbsp;&nbsp; Back &nbsp;&nbsp;</a><br/><br/>';
