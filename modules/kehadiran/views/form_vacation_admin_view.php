...
<script type="text/javascript">
    ...
    var button_hidden_session = '<?php echo $button_hidden_session;?>';
    ...
    $(document).ready(function(){        
        ...
        $('.datepicker-input').datepicker({            
            ...
            onSelect: function (dateText, value) {
                ...
                var EmployeeID = $('[name="<?php echo $secret_code?>EmployeeID"]').val();
                data_post = {
                ...
                $.ajax({
                    "url" : "<?php echo site_url('kehadiran/form_vacation_admin/check_tanggal_masuk/')?>",
                    "type" : "POST",
                    "data" : data_post,
                    "dataType" : "json",
                    "beforeSend" : function(){                        
        ...
        $('.pilih-tanggal-cuti').datepicker({            
            ...
            onSelect: function (dateText, value) {               
                ...
                $.ajax({
                    "url" : "<?php echo site_url('kehadiran/form_vacation_admin/check_double_date/')?>",
                    "type" : "POST",
                    "data" : data_post,
                    "dataType" : "json",
                    "beforeSend" : function(){                        
        ...
        $('.employee-option').selectpicker({style: 'btn-success',size: 'auto'});
        $('.employee-option').selectpicker('refresh'); 

         

        $('#btn_form_cuti').on('click', function(){  
            var status_hidden = button_hidden_session;
            ...
            $.ajax({
                "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_btn_form_cuti/')?>",
                "type" : "POST",
                "data" : data_post,
                "dataType" : "json",
                "beforeSend" : function(){                        
                ...
                "success" : function(data){
                    ...
                    button_hidden_session = data.status;
    ...
    function push_add_utang_cuti(value){
        ...
        $('#modal_kesepakatan_utang').modal('hide');
                ...
                $.ajax({
                    "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_after_term_and_condition/')?>",
                    "type" : "POST",
                    "data" : {"value":value},
                    "dataType" : "json",
                    "beforeSend" : function(){                        
    ...
    function btn_order_save(){
        ...
        $.ajax({
            "url" : "<?php echo site_url('kehadiran/form_vacation_admin/check_before_submit/')?>",
            "type" : "POST",
            "data" : data_post,
            "dataType" : "json",
            "beforeSend" : function(){                        
            ...
            "success" : function(credo){
                ...
                component +='<div class="alert alert-warning" id="no_approval" style="color:red">Form pengajuan cuti ini tidak melalui proses approval. Mohon diperiksa kembali.</div>';
    ...
    function select_option_employee(){

        var component   ='';
        var component2  ='';
        var component3  ='';
        var secret_code = '<?php echo $secret_code;?>';
        ...
        $('[name="<?php echo $secret_code?>detail_cuti_json"]').val('');  
       

    
        $.ajax({
            "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_select_option_employee/')?>",
            "type" : "POST",
            "data" : data_post,
            "dataType" : "json",
            "beforeSend" : function(){                        
            ...
            "success" : function(credo){                
                ...
                $('[name="<?php echo $secret_code?>sisa_cuti_tahunan"]').val(credo.sisa_cuti_tahunan);  
                $('[name="<?php echo $secret_code?>sisa_cuti_besar"]').val(credo.sisa_cuti_besar);    
                $('[name="<?php echo $secret_code?>sisa_cuti_gabungan"]').val(credo.sisa_cuti_gabungan);

                $('[name="<?php echo $secret_code?>NoTelpon"]').val(credo.NoTelpon); 
                $('[name="<?php echo $secret_code?>Alamat"]').val(credo.Alamat);     

                callback_jumlah_semua_cuti();

                component += '<select class="form-control atasan-langsung-option selectpicker" data-container="body" name="'+secret_code+'NIK2" id="'+secret_code+'NIK2" data-show-subtext="true" data-header="{{ language:Pilih Atasan Langsung }}" style="font-size:12px !important" onchange="check_select_option()">';
                component += '<option value="0" selected disabled>{{ language:Pilih Atasan Langsung }}</option>';                   

                $.each(credo.atasan_langsung_data_option, function (key,value) {
                    component += '<option value="'+value.NIK+'" data-subtext="<small>'+value.NIK+'</small>">'+value.Nama+'</option>';
                });

                component += '</select>'; 

                $('#atasan_langsung_option').html(component);

                $('.atasan-langsung-option').selectpicker({style: 'btn-default',size: 'auto'});
                $('.atasan-langsung-option').selectpicker('refresh');


                component2 += '<select class="form-control atasan-lebih-tinggi-option selectpicker" data-container="body" name="'+secret_code+'NIK3" id="'+secret_code+'NIK3" data-show-subtext="true" data-header="{{ language:Pilih Atasan Lebih Tinggi }}" style="font-size:12px !important" onchange="check_select_option()">';
                component2 += '<option value="0" selected disabled>{{ language:Pilih Atasan Lebih Tinggi }}</option>';                   

                $.each(credo.atasan_langsung_data_option, function (key,value) {
                    component2 += '<option value="'+value.NIK+'" data-subtext="<small>'+value.NIK+'</small>">'+value.Nama+'</option>';
                });

                component2 += '</select>'; 

                $('#atasan_lebih_tinggi_option').html(component2);

                $('.atasan-lebih-tinggi-option').selectpicker({style: 'btn-default',size: 'auto'});
                $('.atasan-lebih-tinggi-option').selectpicker('refresh');


                component3 += '<select class="form-control hrd-option selectpicker" data-container="body" name="'+secret_code+'NIK1" id="'+secret_code+'NIK1" data-show-subtext="true" data-header="{{ language:Pilih Verifikator }}" style="font-size:12px !important" onchange="check_select_option()">';
                //component3 += '<option value="0" selected disabled>{{ language:Pilih Verifikator }}</option>';                   

                $.each(credo.hrd_data_option, function (key,value) {
                    component3 += '<option value="'+value.hrd_nik+'" data-subtext="<small>'+value.hrd_nik+'</small>">'+value.hrd_name+'</option>';
                });

                component3 += '</select>'; 

                $('#hrd_option').html(component3);

                $('.hrd-option').selectpicker({style: 'btn-default',size: 'auto'});
                $('.hrd-option').selectpicker('refresh');
    ...
    function check_user_exists(){
        ...
        REQUEST_EXISTS = true;
        REQUEST = $.ajax({
            "url" : "<?php echo site_url('kehadiran/form_vacation_admin/check_registration/')?>",
            "type" : "POST",
            "data" : data_post,
            "dataType" : "json",
            "success" : function(data){
    ...
    function push_submit_form_cuti(){
        ...
        REQUEST = $.ajax({
            "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_submit_form_cuti/')?>",
            "type" : "POST",
            "data" : data_post,
            "dataType" : "json",
            "beforeSend" : function(){                        
            ...
            "success" : function(data){
                ...
                $('[name="<?php echo $secret_code?>sisa_cuti_tahunan"]').val(0);  
                $('[name="<?php echo $secret_code?>sisa_cuti_besar"]').val(0);    
                $('[name="<?php echo $secret_code?>sisa_cuti_gabungan"]').val(0);

                $('.total_gabungan').text(0);
                $('.total_tahunan').text(0);
                $('.total_besar').text(0);

                $('.total_gabungan').switchClass('label-success','label-default');
                $('.total_tahunan').switchClass('label-success','label-default');
                $('.total_besar').switchClass('label-success','label-default');
    ...
    function callback_dialog_detail_cuti(primary_key){
        ...
        REQUEST = $.ajax({
            "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_form_cuti_detail/')?>",
            "type" : "POST",
            "data" : data_post,
            "dataType" : "json",
            "beforeSend" : function(){ 
                ...
                trHTML +='<table class="table table-hover" style="font-size:12px">'+                    
                    '<tbody>'+
                      '<tr>'+
                        ...
                        '<td width="2%">:</td>'+
                        '<td>'+data.result['FormCutiNIK']+' / '+data.result['EmployeeName']+'</td>'+
                      '</tr>'+
                      '<tr>'+
                        '<td>Keperluan</td>'+
                        '<td>:</td>'+
    ...
    function push_void_advance_settlement(){
        ...
        $('#__modal_void_form_cuti').modal('hide');
            ...
            $.ajax({
                    "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_save_void_cuti/')?>",
                    "type" : "POST",
    ...
    function callback_jumlah_semua_cuti(){
        ...
        var data_post = {            
            ...
            $.ajax({
                    "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_total_sejarah_cuti/')?>",
                    "type" : "POST",
                    "data" : data_post,
                    "dataType" : "json",
                    beforeSend : function(){   
    ...
    function callback_sejarah_cuti_hutang(){
        ...
        var data_post = {            
            ...
            $.ajax({
                    "url" : "<?php echo site_url('kehadiran/form_vacation_admin/ajax_sejarah_cuti_hutang/')?>",
                    "type" : "POST",
                    "data" : data_post,
                    "dataType" : "json",
                    beforeSend : function(){  
    ...
    function show_toggle_form_cuti(){

        var status_hidden = button_hidden_session;

        if(status_hidden == 1){
            $('#column_form_cuti').hide();
            $('#column_form_cuti').attr('class','');
            $('#column_table_cuti').attr('class','col-lg-12');
            $('#btn_form_cuti').html('<i class="glyphicon glyphicon-eye-close"></i> Tampilkan form cuti');
        }
        else{
            $('#column_form_cuti').show();
            $('#column_form_cuti').attr('class','col-lg-4');
            $('#column_table_cuti').attr('class','col-lg-8');
            $('#btn_form_cuti').html('<i class="glyphicon glyphicon-eye-open"></i> Sembunyikan form cuti');
        }
    }
...
<div id="crud_transportation">
    <div class="col-lg-4" id="column_form_cuti">
        <div class="card">
        
            <h4>{{ language:Form Permohonan Cuti }}</h4> 
            ...
            echo '<input type="hidden" name="'.$secret_code.'sisa_cuti_tahunan" id="'.$secret_code.'sisa_cuti_tahunan" value="0" placeholder="sisa cuti tahunan"/>';
            echo '<input type="hidden" name="'.$secret_code.'sisa_cuti_besar" id="'.$secret_code.'sisa_cuti_besar" value="0" placeholder="sisa cuti besar"/>';
            echo '<input type="hidden" name="'.$secret_code.'sisa_cuti_gabungan" id="'.$secret_code.'sisa_cuti_gabungan" value="0" placeholder="sisa cuti gabungan"/>';
            ...
            echo '<span class="input-group-addon btn-success"><i class="glyphicon glyphicon-user"></i></span>';   
            echo '<select class="form-control employee-option selectpicker" data-style="btn-primary" data-live-search="true" name="'.$secret_code.'EmployeeID" id="'.$secret_code.'EmployeeID" data-size="10" data-show-subtext="true" data-header="{{ language:Pilih Karyawan }}" style="font-size:12px !important" onchange="select_option_employee()">';
            echo '<option value="0" selected disabled>{{ language:Pilih Karyawan }}</option>';    
            ...
            echo '<table class="table informasi-cuti">
                      <thead>
                        <tr>
                          <th colspan="2" id="total_gabungan">Total sisa cuti <span class="label label-default total_gabungan" style="font-size:12px"></span> hari</th>                         
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td width="80%"><strong>Cuti Tahunan</strong></td>
                          <td id="total_tahunan" class="text-right"><span class="label label-default total_tahunan" style="font-size:12px"></span></td>                          
                        </tr>
                        <tr>
                          <td><strong>Cuti Besar</strong></td>
                          <td id="total_besar" class="text-right"><span class="label label-default total_besar" style="font-size:12px"></span></td>                         
                        </tr>
            ...
            echo '<input type="text" class="form-control" placeholder="{{ language:Nomor telpon yg bisa dihubungi selama cuti }}" value="" name="'.$secret_code.'NoTelpon" id="'.$secret_code.'NoTelpon" />';
            echo '</div>';
            echo '</div>'; 
            echo '</div>';
            ...
            echo '<textarea name="'.$secret_code.'Alamat" id="'.$secret_code.'Alamat" placeholder="{{ language:Alamat selama cuti, minimal 10 karakter }}" class="form-control mention" rows="3" style="height:80px" onkeyup="check_textarea()" style="color:black !important;font-size:small !important"></textarea>';
            echo '</div>';
            echo '</div>';
            ...
            */
            ...
            echo '<div class="input-group">';
            echo '<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>'; 
            echo '<div id="atasan_langsung_option">';  
            echo '<select class="form-control atasan-langsung-option selectpicker" name="'.$secret_code.'NIK2" id="'.$secret_code.'NIK2" data-show-subtext="true" data-header="{{ language:Pilih Atasan Langsung }}" style="font-size:12px !important" onchange="check_select_option()">';
            ...
            */
            ...
            echo '<div class="input-group">';
            echo '<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>';   
            echo '<div id="atasan_lebih_tinggi_option">';
            echo '<select class="form-control atasan-lebih-tinggi-option selectpicker" name="'.$secret_code.'NIK3" id="'.$secret_code.'NIK3" data-show-subtext="true" data-header="{{ language:Pilih Atasan Lebih Tinggi }}" style="font-size:12px !important" onchange="check_select_option()">';
    ...
    <div class="col-lg-8" id="column_table_cuti">
        <div class="card">
