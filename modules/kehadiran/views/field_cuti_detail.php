 <?php
    ...
    if ($listingID !=3){   
        $note_max = 'Max '.$sisacuti.' Days';
        $JumlahSisaCuti = $sisacuti;
    }
    elseif ($listingID ==3){   
        $note_max = '';
        $JumlahSisaCuti = $max_cuti_khusus_ijin;
    }
...
<div id="md_table_citizen_container">
    ...
    <div class="fbutton">
        <span id="md_field_citizen_add" class="add btn btn-default">
            <i class="glyphicon glyphicon-plus-sign"></i> Add Date <?php echo $note_max ?></span>
    </div>
    <br />
...
<script type="text/javascript">
    ...
    $('#md_field_citizen_col_TglCuti_1').attr('disabled', 'disabled');
    $('#md_field_citizen_col_TglCuti_0').datepicker({
        defaultDate: "+1d",
        minDate: 1,
        maxDate: "+3M",
        dateFormat: 'dd/mm/yy',
    ...
    $('#md_field_citizen_col_TglCuti_0').change(function () {
        var from = $('#md_field_citizen_col_TglCuti_0').datepicker('getDate');
        var date_diff = Math.ceil((from.getTime() - Date.parse(today)) / 86400000);
        var maxDate_d = date_diff+7+'d';
        date_diff = date_diff + 'd';
        $('#md_field_citizen_col_TglCuti_1').val('').removeAttr('disabled').removeClass('hasDatepicker').datepicker({
            dateFormat: 'dd/mm/yy',
            minDate: date_diff,
            maxDate: maxDate_d
        });
    ...
    $('#md_field_citizen_col_TglCuti_1').keyup(function () {
        $(this).val('');
        alert('Please select date from Calendar');
    });
    $('#md_field_citizen_col_TglCuti_0').keyup(function () {
        $('#md_field_citizen_col_TglCuti_0,#md_field_citizen_col_TglCuti_1').val('');
        $('#md_field_citizen_col_TglCuti_1').attr('disabled', 'disabled');
        alert('Please select date from Calendar');
    });
...
*/
        ...
        if($("tr.md_field_citizen_tr").length<'<?php echo $JumlahSisaCuti ?>')
            // new data
        var data = new Object();
          //data.KKWTId    = ''; 
          //data.Keterangan = '';
