...
class frmProgressApprovalUser extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        $this->view($this->cms_module_path().'/frmProgressApprovalUser_view', $output,$this->cms_complete_navigation_name('frmProgressApprovalUser'));
    }
