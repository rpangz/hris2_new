 ...
 */
class frmListHakCutiSis extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        if ($this->uri->segment(4) !=0 && !is_null($this->uri->segment(4)) && isset($list)){
            ...
            $crud->where('tbl_hakcuti.companyID', 2);
        ...
        */
		...
		$crud->columns('NIK','NIK2','Periode1','Periode2','PeriodeExt','JenisHakCuti','Qty','StatusHak','companyID');

        $crud->edit_fields('companyID','NIK','Periode1','Periode2','PeriodeKerja1','PeriodeKerja2','PeriodeExt','JenisHakCuti','Qty','QtyPakai','StatusHak');
		$crud->add_fields('companyID','NIK','Periode1','Periode2','PeriodeKerja1','PeriodeKerja2','PeriodeExt','JenisHakCuti','Qty','QtyPakai','StatusHak');
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/frmListHakCutiSis_view', $output,
            $this->cms_complete_navigation_name('frmListHakCutiSis'));
    }
    ...
    public function _callback_column_NIK222($value, $row){    
        return $row->NIK;        
    }
