...
class frmPerpCuti extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->unset_add_fields('CreatedBy','CreatedTime','Tgl1','Tgl2','Alasan','companyID');
		...
		$crud->columns('NIKKI','NIK','HakCutiId2','CreatedTime','ApvLevel','StatusForm');
		...
		$crud->add_fields('NIK','HakCutiId','NIK1','NIK2','CreatedBy','CreatedTime','companyID');
        ...
        $crud->display_as('NIK2','Menyetujui - Atasan');
    ...
    public function _callback_add_field_NIK2(){
        ...
        $empty_select = '<select name="NIK2" class="chosen-select" data-placeholder="Select Mengetahui - Atasan" style="width: 500px; display: none;">';
    ...
    public function get_states(){
        ...
        foreach($db->result() as $row):
            ...
            $inin         = strtotime($row->Periode2);
            $PerPer2       = date('Y-m-d',strtotime('-2 month',$inin));
