...
class frmProgressApproval extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        $this->view($this->cms_module_path().'/frmProgressApproval_view', $output,$this->cms_complete_navigation_name('frmProgressApproval'));
    }
