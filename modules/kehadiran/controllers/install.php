...
/**
 * Installation script for kehadiran
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.kehadiran';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Kehadiran',
            $module_path.'/kehadiran', $this->PRIV_EVERYONE);
