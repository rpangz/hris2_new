...
class frmAttendance extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        $this->view($this->cms_module_path().'/frmAttendance_view', $output,
            $this->cms_complete_navigation_name('frmAttendance'));
    }
