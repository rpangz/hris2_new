...
/**
 * Installation script for matrik
 *
...
class Install extends CMS_Module_Installer {
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Matrik',
            $module_path.'/matrik', $this->PRIV_EVERYONE);
