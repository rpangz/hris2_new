...
class frmMatrikApproval extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        // table name
        $crud->set_table($this->cms_complete_table_name('matrikapproval'));
		...
		$crud->columns('MatCode','MatProses','MatName','MatAction','MatStatus','MatCompanyId');
        $crud->edit_fields('MatCode','MatProses','MatName','MatAction','MatStatus');
		$crud->add_fields('MatCode','MatProses','MatName','MatAction','MatStatus');
		...
		$crud->required_fields('MatCode','MatProses','MatName','MatAction','MatStatus');
        ...
        if(!$crud->unset_delete){
            ...
            foreach($id_list as $id){
                if($this->_before_delete($id)){
                    $this->db->delete($this->cms_complete_table_name('matrikapproval'),array('MatId'=>$id));
