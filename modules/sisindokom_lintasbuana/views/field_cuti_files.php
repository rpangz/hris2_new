...
<table id="md_table_photos" class="table table-striped table-bordered">
    <thead>
        <tr>
            <th style="width:300px;">Attachment File</th>
...
<input id="md_field_photos_add" class="btn btn-default" type="button" value="Add File" />
<br />
...
<script type="text/javascript">
    ...
    function add_table_row_photos(value){
        ...
        component += '<td>';
        component += '<input style="width: 250px;" id="md_field_photos_col_file_name_'+RECORD_INDEX_photos+'" record_index="'+RECORD_INDEX_photos+'" class="md_field_photos_col" column_name="file_name" type="text" value="'+field_value+'"/>';
        component += '</td>';
        */
