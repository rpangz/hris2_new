 ...
 */
class frmListFormIjinSis extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        if ($this->uri->segment(4) !=0 && !is_null($this->uri->segment(4)) && isset($list)){
            ...
            $crud->where('tbl_formijin.companyID', $company_id);
        }
        else {
        ...
        //$crud->set_relation('NIK', $this->cms_complete_table_name('profile'), 'Nama',array('CompanyId' => 2));
        ...
        $crud->set_relation('NIK2', $this->cms_complete_table_name('apv_hrd'), '{hrd_name}',array('hrd_status' => 1, 'hrd_company' => $company_id));
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmListFormIjinSis_view', $output,
        $this->cms_complete_navigation_name('frmListFormIjinSis'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/sisindokom_lintasbuana/frmListFormIjin/get_states/', site_url().'/sisindokom_lintasbuana/frmListFormIjin/get_cities/'),
    ...
    public function _after_insert($post_array, $primary_key){
        ...
        if ($SendMail ==1){
            include "http://$_SERVER[SERVER_NAME]/hris2/includes/mailer/frmListFormIjinSis/SendMailUser.php?id=$ID&nik=$NIK";
    ...
    public function _callback_column_NIKKI($value, $row){
        ...
        foreach ($query->result() as $rown){
            return "<a href='".site_url($this->cms_module_path().'/'.$this->uri->segment('2').'/index/edit/'.$row->IjinId)."'>$rown->Nama</a>";
        }
    ...
    public function _callback_column_Print($value, $row){    
       ...
       //foreach ($query->result() as $rown){
        //return $row->Nama.'Ku';
           // http://astapp02/hris2/includes/export/frmListFormIjin/Export2Html.php?id=1
            //return "<a href=http://astapp02/hris2/includes/export/frmListFormIjin/Export2Html.php?id=".$row->IjinId">Print</a>";

            //return "<a href=http://astapp02/hris2/includes/export/frmListFormIjin/Export2Html.php?id=".$row->IjinId." target=_blank> Print</a>";
            //return "javascript:openBlank('".site_url('includes/export/frmListFormIjin/Export2Html.php') . '?id=' . $row->IjinId . "')";
            ...
            //return "<a href=http://astapp02/hris2/includes/export/frmListFormIjin/Export2Html.php?id=".$row->IjinId." target=_blank><img style=border:0; src='http://astapp02/hris2/includes/images/print1.png' onmouseover=this.src='http://astapp02/hris2/includes/images/print2.png' onmouseout=this.src='http://astapp02/hris2/includes/images/print1.png' title='print' alt='print' width=16 height=16></a>";
