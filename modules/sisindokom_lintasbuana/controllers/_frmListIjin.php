 ...
 */
class frmListIjin extends CMS_Priv_Strict_Controller {
    ...
    public function _example_output($output = null){
        ...
        $this->view($this->cms_module_path().'/frmListIjin_view', $output,
        $this->cms_complete_navigation_name('frmListIjin'));    
    }
    ...
    public function index(){
        ...
        $dd_data = array(
                ...
                'dd_url' => array('', site_url().'/sisindokom_lintasbuana/frmListIjin/get_states/', site_url().'/sisindokom_lintasbuana/frmListIjin/get_cities/'),
