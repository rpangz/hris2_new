...
/**
 * Installation script for Sisindokom_Lintasbuana
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.sisindokom_lintasbuana';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Sisindokom Lintasbuana',
            $module_path.'/sisindokom_lintasbuana', $this->PRIV_EVERYONE);
