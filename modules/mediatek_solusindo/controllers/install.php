...
/**
 * Installation script for mediatek_solusindo
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.mediatek_solusindo';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Mediatek Solusindo',
            $module_path.'/mediatek_solusindo', $this->PRIV_EVERYONE);
