...
class frmListAttendance extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/frmListAttendance_view', $output,
            $this->cms_complete_navigation_name('frmListAttendance'));
    }
