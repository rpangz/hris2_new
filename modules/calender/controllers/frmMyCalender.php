 ...
 */
class frmMyCalender extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
		...
		$crud->columns('CutiId','FormCutiNIK','TglMasuk','Keperluan','StatusForm','ApvLevel');
		...
		$crud->required_fields('FormCutiNIK','TglActive1','Keperluan','StatusForm','ApvLevel');
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/frmMyCalender_view', $output,
            $this->cms_complete_navigation_name('frmMyCalender'));
    }
