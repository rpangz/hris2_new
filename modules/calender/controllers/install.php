...
/**
 * Installation script for calender
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.calender';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Calender',
            $module_path.'/calender', $this->PRIV_EVERYONE);
