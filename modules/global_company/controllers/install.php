...
/**
 * Installation script for global_company
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.global_company';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Global Company',
            $module_path.'/global_company', $this->PRIV_EVERYONE);
