...
/**
 * Installation script for provis
 *
...
class Install extends CMS_Module_Installer {
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Provis',
            $module_path.'/provis', $this->PRIV_EVERYONE);
