...
class frmListFormIjin extends CMS_Priv_Strict_Controller {
    ...
    private function make_crud(){
        ...
        */
        ...
        $crud->field_type('companyID', 'hidden', $company_id);       
       ...
       // $crud->set_relation('JabatanID', $this->cms_complete_table_name('jabatan'), 'NamaJabatan');
        ...
        $crud->add_action('Print', 'https://'.$_SERVER['SERVER_NAME'].'/hris2/includes/images/print1.png', '','https://'.$_SERVER['SERVER_NAME'].'/hris2/includes/images/print1.png',array($this,'_callback_column_Print'));
    ...
    public function _after_insert($post_array, $primary_key){
        ...
        if ($SendMail ==1){
            include "https://$_SERVER[SERVER_NAME]/hris2/includes/mailer/frmListFormIjin/SendMailUser.php?id=$ID&nik=$NIK";
