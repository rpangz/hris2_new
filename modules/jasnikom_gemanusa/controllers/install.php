...
/**
 * Installation script for jasnikom_gemanusa
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.jasnikom_gemanusa';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Jasnikom Gemanusa',
            $module_path.'/jasnikom_gemanusa', $this->PRIV_EVERYONE);
