...
/**
 * Installation script for admin_datacell
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_datacell';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Datacell',
            $module_path.'/admin_datacell', $this->PRIV_EVERYONE);
