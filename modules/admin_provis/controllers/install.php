...
/**
 * Installation script for admin_provis
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_provis';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Provis',
            $module_path.'/admin_provis', $this->PRIV_EVERYONE);
