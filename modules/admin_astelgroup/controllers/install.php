...
/**
 * Installation script for admin_astelgroup
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.admin_astelgroup';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Admin Astelgroup',
            $module_path.'/admin_astelgroup', $this->PRIV_EVERYONE);
