...
/**
 * Installation script for reminder
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'dompak.reminder';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Reminder',
            $module_path.'/reminder', $this->PRIV_EVERYONE);
