...
default:
	default:
	echo"<form name='form2' id='form2' action='module=$_GET[module]&act=bSearch' method='POST'>
	<table>
	...
	echo"</select></td>  
  <td>Departemen:<select name=iDeptID>
	<option value='0'>---All---</option>";
    $sql = mssql_query("SELECT * FROM tbDept WHERE iDeptID !=0 AND iCompanyId=$_SESSION[CompanyId] ORDER BY cDeptName ASC");					  
		  while ($data = mssql_fetch_array($sql)){
