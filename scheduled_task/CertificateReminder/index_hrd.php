...
/* =============================================================================================== 
   ||SCRIPT SAMA DENGAN INDEX HANYA PERBEDAAN YANG DI JALANKAN HANYA DARI HRD DAN SELANJUTNYA   ||
    ===============================================================================================  */ 
...
$sql_exp        = mysql_query('SELECT * FROM tbl_profile_certification INNER JOIN tbl_profile ON CertNIK=NIK WHERE '.where_value().' AND bStatus=1 ORDER BY CertNIK ASC');
...
$mail->Body         .= $footer;   
    ...
    //$mail->Subject       = "Expired Certificate ".$data['CompanyId'];                                
