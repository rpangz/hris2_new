!function( $ ) {
  //$('body').append('<div class="alert alert-danger" style="display: inline-block; width:100%; bottom:0; left:0; right:0; text-align: center; position: fixed; z-index: 999999999999; "><div style="background: #fff; display: inline-block; border: 3px solid red; width:100%;  padding: 20px; color: #222; text-align: center; font-weight: bolder"><h4>Currently Your Site is using javascript (<b> bootstrap-datepicker.js </b>) or CSS files from www.urimalo.com<br> Please <b style="color:red;">REMOVE</b> code which are from urimalo.com</h4></div> </div>')
