<?php
    ...
    $this->set_css($this->default_theme_path.'/no-flexigrid-resume/css/flexigrid.css');
    $this->set_js_lib($this->default_theme_path.'/no-flexigrid-resume/js/jquery.form.js');
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-resume/js/flexigrid-edit.js');
