<?php
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-general/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-general/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-general/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-general/js/jquery.printElement.min.js');
