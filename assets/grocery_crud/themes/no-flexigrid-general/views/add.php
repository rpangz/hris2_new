<?php
    ...
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-general/js/flexigrid-add.js');

    $this->set_js_lib($this->default_javascript_path.'/jquery_plugins/jquery.noty.js');
    $this->set_js_lib($this->default_javascript_path.'/jquery_plugins/config/jquery.noty.config.js');
?>
<div class="flexigrid crud-form box box-success" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="mDiv">
        <div class="ftitle">
    ...
    <?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
        ...
        <div class="pDiv box-footer">
            <div class='form-button-box'>
                <button type="button" id="save-and-go-back-button" class="btn btn-primary btn-large btn-flat"><i class="glyphicon glyphicon-floppy-disk"></i> <?php echo $this->l('form_save'); ?></button>
            </div>
