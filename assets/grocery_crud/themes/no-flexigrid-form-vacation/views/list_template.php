<?php
	$this->set_css($this->default_theme_path.'/no-flexigrid-form-vacation/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-vacation/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-vacation/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-vacation/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-vacation/js/jquery.printElement.min.js');
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
    ...
    <div class="mDiv">
        <div class="ftitle">
            <h4 class="box-title"><?php echo $subject?></h4>
        </div>
    </div>
    ...
    <div class="tDiv">
        ...
        <div class="tDiv2">
            ...
            <!--
            <a href='<?php echo site_url('kehadiran/form_vacation/tambah/');?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button btn btn-default'>
            <div class="fbutton">
                <div>
                    <span class="add"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<?php echo $this->l('list_add'); ?></span>
                </div>
            </div>
            </a>-->

            <button type="button" class="btn btn-default btn-lg" id="btn_form_cuti"><i class="glyphicon glyphicon-eye-open"></i> Tampilkan form cuti</button>
