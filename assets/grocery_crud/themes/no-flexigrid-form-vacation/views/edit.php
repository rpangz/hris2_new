<?php
    ...
    $this->set_js_lib($this->default_theme_path.'/no-flexigrid-form-vacation/js/jquery.form.js');
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-form-vacation/js/flexigrid-edit.js');
