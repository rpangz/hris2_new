<?php
    ...
    $this->set_js_lib($this->default_theme_path.'/no-flexigrid-employee-kpi/js/jquery.form.js');
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-employee-kpi/js/flexigrid-edit.js');
    ...
    <div class="mDiv">
        <div class="ftitle">
            <div class='box-header with-border'>
                <h4 class="box-title"><?php echo $this->l('form_edit'); ?> IPP</h4>
            </div>
            <div class='clear'></div>
        </div>
    </div>
...
<?php     if(!$this->unset_back_to_list) { ?>
        <div class='form-button-box'>
            <input type='button' value='<?php echo $this->l('form_update_changes'); ?>' id="save-and-go-back-button" class="btn btn-primary btn-large"/>
        </div>
        <div class='form-button-box'>
