        ...
        <tr rowId="<?php echo $rowId; ?>" <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
            ...
            <td align="left" width='20%'>
                <div class='tools'>
                    ...
                    <?php if(!$unset_read){?>
                        &nbsp;
                        <a href='<?php echo $row->read_url?>' title='<?php echo $this->l('list_view')?> <?php echo $subject?>' class="edit_button btn btn-xs btn-default btn-flat">
                              <span class='read-icon'><i class="glyphicon glyphicon-pencil"></i></span>
                        </a>
                    <?php }?>
                    <?php if(!$unset_edit){?>&nbsp;
                        <a href='<?php echo $row->edit_url?>' title='<?php echo $this->l('list_edit')?>' class="edit_button">
                              <span class='edit-icon'><i class="glyphicon glyphicon-pencil"></i></span>
                        </a>
                    <?php }?>
                    <?php if(!$unset_delete){?>&nbsp;
                        <a href='<?php echo $row->delete_url?>' title='<?php echo $this->l('list_delete')?>' class="delete-row" >
