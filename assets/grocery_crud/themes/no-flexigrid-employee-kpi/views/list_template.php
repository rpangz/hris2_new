<?php
	$this->set_css($this->default_theme_path.'/no-flexigrid-employee-kpi/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-employee-kpi/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-employee-kpi/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-employee-kpi/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-employee-kpi/js/jquery.printElement.min.js');
...
if($success_message !== null){?>
	<p>Your data has been successfully stored into the database.</p>
<?php }
?></div>
...
-->
	...
	<div class="tDiv">
        ...
        <div class="btn-group pull-right">
            ...
            <div class="fbutton">
                <div>
                    <span class="add"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<?php echo $this->l('list_add'); ?> IPP</span>
                </div>
            </div>
            </a>
