<?php
	$this->set_css($this->default_theme_path.'/flexigrid_1/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/flexigrid_1/js/cookies.js');
	$this->set_js($this->default_theme_path.'/flexigrid_1/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/flexigrid_1/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/flexigrid_1/js/jquery.printElement.min.js');
