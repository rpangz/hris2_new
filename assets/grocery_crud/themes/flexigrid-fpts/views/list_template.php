<?php
	...
	$crud = new frmTrainingCertificate();
	$company_select = $crud->dropdown_select_company();
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv2">
        	...
        	<a href='#getConnection' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' data-toggle="modal" class='add-anchor add_button getConnection-modal'>
			<div class="fbutton">
				<div>
...
<div id="getConnection" class="modal2 fade" aria-hidden="true">
        <div class="modal2-dialog">
            <div class="modal2-content">
                <div class="modal2-header">
                    <button type="button" class="close" data-dismiss="modal2" aria-hidden="true">×</button>
                    <h4 class="modal2-title"><span class="label label-success"><span class="glyphicon glyphicon-cloud"></span> Please Select Company First...</span></h4>
                </div>
               <?php echo form_open($add_url,'method="post" autocomplete="off"'); ?> 
               ...
               <?php echo $company_select; ?>
                ...
                <div class="modal2-footer">
                    ...
                    <input type="submit" value=" Next Step" id="connection_btn" class = "btn btn-primary" disabled/> 
                </div>
            </form>
            </div>
        </div>
...
function select_connection(){
    var x = document.getElementById("get_company").value;
