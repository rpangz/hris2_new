<?php
	$this->set_css($this->default_theme_path.'/no-action-flexigrid/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/no-action-flexigrid/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-action-flexigrid/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-action-flexigrid/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-action-flexigrid/js/jquery.printElement.min.js');
