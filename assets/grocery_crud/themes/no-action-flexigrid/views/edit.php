<?php
	...
	$this->set_js_lib($this->default_theme_path.'/no-action-flexigrid/js/jquery.form.js');
	$this->set_js_config($this->default_theme_path.'/no-action-flexigrid/js/flexigrid-edit.js');
