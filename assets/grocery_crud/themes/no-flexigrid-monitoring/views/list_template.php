<?php
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-monitoring/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-monitoring/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-monitoring/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-monitoring/js/jquery.printElement.min.js');
