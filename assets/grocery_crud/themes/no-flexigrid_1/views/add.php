<?php
    ...
    $this->set_js_config($this->default_theme_path.'/no-flexigrid_1/js/flexigrid-add.js');
    ...
    <?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
        ...
        <div class="pDiv">
            <div class='form-button-box'>
                <input id="save-and-go-back-button" type='button' value='<?php echo $this->l('form_save'); ?>'  class="btn btn-default btn-large"/>
            </div>
