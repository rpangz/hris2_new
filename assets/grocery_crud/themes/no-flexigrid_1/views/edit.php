<?php
    ...
    $this->set_css($this->default_theme_path.'/no-flexigrid_1/css/flexigrid.css');
    $this->set_js_lib($this->default_theme_path.'/no-flexigrid_1/js/jquery.form.js');
    $this->set_js_config($this->default_theme_path.'/no-flexigrid_1/js/flexigrid-edit.js');
...
<div id='main-table-box'>
    ...
    <div class="pDiv">
        <!--<div class='form-button-box'>
            <input  id="form-button-save" type='submit' value='<?php //echo $this->l('form_update_changes'); ?>' class="btn btn-default btn-large"/>
        </div>-->
<?php     if(!$this->unset_back_to_list) { ?>
        <div class='form-button-box'>
            <input type='button' value='<?php echo $this->l('form_update_changes'); ?>' id="save-and-go-back-button" class="btn btn-default btn-large"/>
        </div>
        <div class='form-button-box'>
