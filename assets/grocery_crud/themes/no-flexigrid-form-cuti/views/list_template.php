<?php
	$this->set_css($this->default_theme_path.'/no-flexigrid-form-cuti/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-cuti/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-cuti/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-cuti/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-form-cuti/js/jquery.printElement.min.js');
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		<?php if(!$unset_add){?>
        <div class="tDiv2">
            <a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button btn btn-default btn-sm'>
            <div class="fbutton">
                <div>
		...
		<div class="tDiv3">
			<?php if(!$unset_export) { ?>
            <a class="export-anchor btn btn-default btn-sm" data-url="<?php echo $export_url; ?>" target="_blank">
                <div class="fbutton">
                    <div>
