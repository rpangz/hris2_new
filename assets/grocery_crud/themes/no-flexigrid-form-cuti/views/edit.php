<?php
    ...
    $this->set_js_lib($this->default_theme_path.'/no-flexigrid-form-cuti/js/jquery.form.js');
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-form-cuti/js/flexigrid-edit.js');
...
<?php     if(!$this->unset_back_to_list) { ?>
        <div class='form-button-box'>
            <input type='button' value='<?php echo $this->l('form_update_and_go_back'); ?>' id="save-and-go-back-button" class="btn btn-default btn-large"/>
        </div>
        <div class='form-button-box'>
