<?php
    ...
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-default/js/flexigrid-add.js');
    ...
    <?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
        ...
        <div class="pDiv box-footer">
            <div class='form-button-box'>
                <button type="button" id="save-and-go-back-button" class="btn btn-primary btn-large btn-flat"><i class="fa fa-floppy-o"></i> <?php echo $this->l('form_save'); ?></button>
            </div>
