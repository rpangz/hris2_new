<?php
    ...
    $this->set_js_lib($this->default_theme_path.'/no-flexigrid-default/js/jquery.form.js');
    $this->set_js_config($this->default_theme_path.'/no-flexigrid-default/js/flexigrid-edit.js');
...
<div id='main-table-box' class="box-body">
    ...
    <div class="pDiv box-footer">
        <div class='form-button-box'>
            <button type="button" id="save-and-go-back-button" class="btn btn-primary btn-large btn-flat"><i class="fa fa-floppy-o"></i> <?php echo $this->l('form_update_changes'); ?></button>
        </div>        
        <div class='form-button-box'>
            <button type="button" id="cancel-button" class="btn btn-default btn-large btn-flat"><i class="fa fa-reply"></i> <?php echo $this->l('form_cancel'); ?></button>
        </div>
