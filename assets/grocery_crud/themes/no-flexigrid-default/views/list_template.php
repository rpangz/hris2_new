<?php
	$this->set_css($this->default_theme_path.'/no-flexigrid-default/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-default/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-default/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-default/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-default/js/jquery.printElement.min.js');
...
<div class="flexigrid box box-default" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
    ...
    <div class="box-header with-border">
        <div class="pull-right box-tools">
            <?php if(!$unset_export) { ?>
            <a class="export-anchor btn btn-default btn-sm btn-flat pull-right" title="<?php echo $this->l('list_export');?>" data-url="<?php echo $export_url; ?>" target="_blank" style="margin-right: 5px;">
                <div class="fbutton">
                    <div>
            ...
            <?php if(!$unset_print) { ?>
            <a class="print-anchor btn btn-default btn-sm btn-flat pull-right" title="<?php echo $this->l('list_print');?>" data-url="<?php echo $print_url; ?>" style="margin-right: 5px;">
                <div class="fbutton">
                    <div>
                        <span class="print"><i class="fa fa-print fa-lg"></i></span>
                    </div>
                </div>
            </a>            
            <?php }?>
            ...
            <?php if(!$unset_add){?>            
                <a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?>' class='add-anchor add_button btn btn-default btn-sm btn-flat pull-right' style="margin-right: 5px;">
                <div class="fbutton">
                    <div>
                        <span class="add"><i class="fa fa-plus-circle fa-lg"></i></span>
                    </div>
                </div>
                </a>           
            <?php }?>
	...
	<div class="tDiv">
		<?php if(!$unset_add){?>
        <div class="tDiv2">
            <a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button btn btn-default btn-flat'>
            <div class="fbutton">
                <div>
		...
		<div class="tDiv3">
			<?php if(!$unset_export) { ?>
            <a class="export-anchor btn btn-default btn-flat" data-url="<?php echo $export_url; ?>" target="_blank">
                <div class="fbutton">
                    <div>
            ...
            <?php } ?>
            <?php if(!$unset_print) { ?>
            <a class="print-anchor btn btn-default btn-flat" data-url="<?php echo $print_url; ?>">
                <div class="fbutton">
                    <div>
	...
	<div class="pDiv">
		...
		<div style="clear: both;" id="result_of_data">
