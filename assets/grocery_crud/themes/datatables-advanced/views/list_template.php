<?php
	...
	$this->set_css($this->default_theme_path.'/datatables-advanced/datatables/dataTables.bootstrap.css');
	...
	$this->set_js($this->default_theme_path.'/datatables-advanced/js/datatables.js');
	...
	$this->set_js_lib($this->default_theme_path.'/datatables-advanced/datatables/jquery.dataTables.min.js');
	$this->set_js_lib($this->default_theme_path.'/datatables-advanced/datatables/dataTables.bootstrap.min.js');
...
<a class="btn btn-default btn-flat" href="<?php echo $add_url?>">
    <i class="fa fa-plus-square"></i> <?php echo $this->l('list_add'); ?> <?php echo $subject?>
</a>
    ...
    <div class="box-header">
    	<div class="form-group">
            ...
            <a class="btn btn-default btn-flat pull-right" id="btnExcel" data-url="<?php echo $export_url; ?>" target="_blank">
				<div class="fbutton">
					<div>
						<span class="fa fa-file-excel-o"> <?php echo $this->l('list_export');?></span>
					</div>
				</div>
            </a>                     
            <?php } ?>
