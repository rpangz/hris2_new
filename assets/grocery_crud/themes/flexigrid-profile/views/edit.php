<?php
	...
	$this->set_js_lib($this->default_theme_path.'/flexigrid-profile/js/jquery.form.js');
	$this->set_js_config($this->default_theme_path.'/flexigrid-profile/js/flexigrid-edit.js');
