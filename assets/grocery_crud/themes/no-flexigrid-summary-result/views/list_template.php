<?php
	$this->set_css($this->default_theme_path.'/no-flexigrid-summary-result/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/no-flexigrid-summary-result/js/cookies.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-summary-result/js/flexigrid.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-summary-result/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/no-flexigrid-summary-result/js/jquery.printElement.min.js');
