...
<html lang="{{ language:language_alias }}">
    <head>
        ...
        <?php
            ...
            $asset->add_cms_css('bootstrap/css/bootstrap-select.min.css');
    ...
    <body>
        ...
        <?php
            //$asset->add_cms_js("jquery/jquery-1.9.1.js");
            //$asset->add_cms_js("jquery/jquery-ui.js");
            ...
            <div class="row-fluid">
                ...
                <div>     
                    <div id="__section-left-and-content" class="col-md-12">
                        <div>{{ navigation_path }}</div><hr class="line-top" />
        ...
        {{ widget_name:section_script_message }}
        {{ widget_name:welcome_alert }}
